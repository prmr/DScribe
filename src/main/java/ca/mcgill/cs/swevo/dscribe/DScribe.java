...
/**
 * The main entry point of DScribe, which uses Picocli. A CLI-based approach enables easy wrapping
 * for both IntelliJ and Eclipse plugins.
 */
@Command(name = "dscribe", mixinStandardHelpOptions = true, synopsisSubcommandLabel = "COMMAND",
