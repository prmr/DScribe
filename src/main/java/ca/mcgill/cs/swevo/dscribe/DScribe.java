 ...
 * Eclipse plugins.
 */
@Command(name = "dscribe", mixinStandardHelpOptions = true, synopsisSubcommandLabel = "COMMAND", subcommands = {
		GenerateTests.class, GenerateDocs.class })
public class DScribe implements Runnable
{
	...
	/**
	 * If a subcommand e.g. generateTests is not specified, an error is thrown. The help menu will be displayed for the
	 * user.
	 */
	@Override
	public void run()
