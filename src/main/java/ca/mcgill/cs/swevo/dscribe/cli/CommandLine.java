...
/**
 * <p>
 * CommandLine interpreter that uses reflection to initialize an annotated user object with values
 * obtained from the command line arguments.
 * </p>
 * <h2>Example</h2>
 * <p id="checksum_example">
 * An example that implements {@code Callable} and uses the {@link #execute(String...)
 ...
 * </pre>
 * <p>
 * Another example where the application calls {@code parseArgs} and takes responsibility for error
 * handling and checking whether the user requested help:
 * </p>
 * 
 * <pre>
...
public class CommandLine {
   ...
   * annotated user object or a {@link CommandSpec CommandSpec}) and a default {@linkplain IFactory
   * factory}.
   * <p>
   ...
   * {@code @Parameters}-annotated methods, picocli creates a {@link java.lang.reflect.Proxy Proxy}
   * whose methods return the matched command line values. If the specified command object is a
   * concrete {@code Class}, picocli delegates to the default factory to get an instance.
   * </p>
   * <p>
   * If the specified object implements {@code Runnable} or {@code Callable}, or if it is a
   * {@code Method} object, the command can be run as an application in a
   * <a href="#checksum_example">single line of code</a> by using the {@link #execute(String...)
   * execute} method to omit some boilerplate code for handling help requests and invalid input. See
   * {@link #getCommandMethods(Class, String) getCommandMethods} for a convenient way to obtain a
   * command {@code Method}.
   * </p>
   * <p>
   * When the {@link #parseArgs(String...)} method is called, the {@link CommandSpec CommandSpec}
   * object will be initialized based on command line arguments. If the commandSpec is created from
   * an annotated user object, this user object will be initialized based on the command line
   * arguments.
   * </p>
   * 
   * @param command an annotated user object or a {@code CommandSpec} object to initialize from the
   *        command line arguments
   * @throws InitializationException if the specified command object does not have a
   ...
   * {@code @Parameters}-annotated methods, picocli creates a {@link java.lang.reflect.Proxy Proxy}
   * whose methods return the matched command line values. If the specified command object is a
   * concrete {@code Class}, picocli delegates to the {@linkplain IFactory factory} to get an
   * instance.
   * </p>
   * <p>
   * If the specified object implements {@code Runnable} or {@code Callable}, or if it is a
   ...
   * @param command an annotated user object or a {@code CommandSpec} object to initialize from the
   *        command line arguments
   * @param factory the factory used to create instances of {@linkplain Command#subcommands()
   *        subcommands}, {@linkplain Option#converter() converters}, etc., that are registered
   ...
   * @param mixin an annotated user object or a {@link CommandSpec CommandSpec} object whose options
  ...
  /**
   * Returns a map of user objects whose options and positional parameters were added to ("mixed in"
   * with) this command.
   * 
   ...
   *         {@link CommandSpec#mixins() underlying config} directly.
   * @since 3.0
   */
  ...
  /**
   * Registers a subcommand with the name obtained from the {@code @Command(name = "...")}
   * {@linkplain Command#name() annotation attribute} of the specified command.
   * 
   * @param command the object to initialize with command line arguments following the subcommand
   *        name. This may be a {@code Class} that has a {@code @Command} annotation, or an instance
   *        of such a class, or a {@code ComandSpec} or {@code CommandLine} instance with its own
   *        (nested) subcommands.
   * @return this CommandLine object, to allow method chaining
   * @since 4.0
   * @throws InitializationException if no name could be found for the specified subcommand, or if
   *         another subcommand was already registered under the same name, or if one of the aliases
   ...
   *
   * <p>
   * The specified object can be an annotated object or a {@code CommandLine} instance with its own
   * nested subcommands. For example:
   * </p>
   * 
   * <pre>
   * CommandLine commandLine =
   *     new CommandLine(new MainCommand()).addSubcommand("cmd1", new ChildCommand1()) // subcommand
   *         .addSubcommand("cmd2", new ChildCommand2())
   *         .addSubcommand("cmd3", new CommandLine(new ChildCommand3()) // subcommand
   *                                                                     // with
   *                                                                     // nested
   *                                                                     // sub-subcommands
   *             .addSubcommand("cmd3sub1", new GrandChild3Command1())
   *             .addSubcommand("cmd3sub2", new GrandChild3Command2())
   *             .addSubcommand("cmd3sub3", new CommandLine(new GrandChild3Command3()) // deeper
   *                                                                                   // nesting
   ...
   * </p>
   *
   * @param name the string to recognize on the command line as a subcommand. If {@code null}, the
   *        {@linkplain CommandSpec#name() name} of the specified subcommand is used; if this is
   *        also {@code null}, the first {@linkplain CommandSpec#aliases() alias} is used.
   * @param command the object to initialize with command line arguments following the subcommand
   *        name. This may be a {@code Class} that has a {@code @Command} annotation, or an instance
   *        of such a class, or a {@code ComandSpec} or {@code CommandLine} instance with its own
   *        (nested) subcommands.
   ...
   * @throws InitializationException if the specified name is {@code null}, and no alternative name
   *         could be found, or if another subcommand was already registered under the same name, or
   *         if one of the aliases of the specified subcommand was already used by another
   *         subcommand.
   */
   ...
   *        of such a class, or a {@code ComandSpec} or {@code CommandLine} instance with its own
   *        (nested) subcommands.
   * @param aliases zero or more alias names that are also recognized on the command line as this
   *        subcommand
   * @return this CommandLine object, to allow method chaining
   * @since 3.1
   * @see #addSubcommand(String, Object)
  ...
  public boolean isUsageHelpRequested() {
    return interpreter.parseResultBuilder != null
        && interpreter.parseResultBuilder.usageHelpRequested;
  }
  ...
  public boolean isVersionHelpRequested() {
    return interpreter.parseResultBuilder != null
        && interpreter.parseResultBuilder.versionHelpRequested;
  }
   ...
   * This ordering may be modified with {@link #setHelpSectionKeys(List) setSectionKeys}. The
   * default keys are (in order):
   * <ol start="0">
   ...
   * </p>
   * <p>
   * Use {@link UsageMessageSpec#sectionKeys(List)} to customize a command without affecting its
   * subcommands.
   * </p>
   * 
  ...
  /**
   * Returns the map of section keys and renderers used to construct the usage help message. The
   * usage help message can be customized by adding, replacing and removing section renderers from
   * this map. Sections can be reordered with {@link #setHelpSectionKeys(List) setSectionKeys}.
   * Sections that are either not in this map or not in the list returned by
   * {@link #getHelpSectionKeys() getSectionKeys} are omitted.
   * <p>
   * NOTE: By modifying the returned {@code Map}, only the usage help message <em>of this
   * command</em> is affected. Use {@link #setHelpSectionMap(Map)} to customize the usage help
   * message for this command <em>and all subcommands</em>.
   * </p>
   * 
   * @since 3.9
   */
   ...
   * </p>
   * <p>
   * Use {@link UsageMessageSpec#sectionMap(Map)} to customize a command without affecting its
   * subcommands.
   * </p>
   * 
  ...
  /**
   * Returns whether line breaks should take wide Chinese, Japanese and Korean characters into
   * account for line-breaking purposes. The default is {@code true}.
   * 
   * @return true if wide Chinese, Japanese and Korean characters are counted as double the size of
   *         other characters for line-breaking purposes
   * @since 4.0
   */
  ...
  /**
   * Sets whether line breaks should take wide Chinese, Japanese and Korean characters into account,
   * and returns this UsageMessageSpec. The default is {@code true}.
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
   * Subcommands added later will have the default setting. To ensure a setting is applied to all
   ...
   * </p>
   * 
   * @param adjustForWideChars if true, wide Chinese, Japanese and Korean characters are counted as
   ...
   * matched. From 4.0, this is {@code false} by default, and when a flag option is specified on the
   * command line picocli will set its value to the opposite of its default value. If this method
   * returns {@code true}, flags are toggled, so if the value is {@code true} it is set to
   * {@code false}, and when the value is {@code false} it is set to {@code true}. When toggling is
   * enabled, specifying a flag option twice on the command line will have no effect because they
   ...
   * The default is {@code false}, and when a flag option is specified on the command line picocli
  ...
  /**
   * Returns whether whether variables should be interpolated in String values. The default is
   * {@code true}.
   * 
   * @since 4.0
   */
  ...
  /**
   * Sets whether whether variables should be interpolated in String values. The default is
   * {@code true}.
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
   ...
   * 
   * @return {@code true} if short options like {@code -x -v -f SomeFile} can be clustered together
   *         like {@code -xvfSomeFile}, {@code false} otherwise
   * @since 3.0
   */
  ...
  /**
   * Returns whether the parser should ignore case when converting arguments to {@code enum} values.
  ...
  /**
   * Returns whether the parser should trim quotes from command line arguments. The default is read
   * from the system property "picocli.trimQuotes" and will be {@code true} if the property is
   * present and empty, or if its value is "true".
   * <p>
   * If this property is set to {@code true}, the parser will remove quotes from the command line
   * arguments, as follows:
   * <ul>
   * <li>if the command line argument contains just the leading and trailing quote, these quotes are
   * removed</li>
   * <li>if the command line argument contains more quotes than just the leading and trailing quote,
   * the parser first tries to process the parameter with the quotes intact. For example, the
   * {@code split} regular expression inside a quoted region should be ignored, so arguments like
   * {@code "a,b","x,y"} are handled correctly. For arguments with nested quotes, quotes are removed
   * later in the processing pipeline, after {@code split} operations are applied.</li>
   * </ul>
   * </p>
   * 
   ...
   * The default is read from the system property "picocli.trimQuotes" and will be {@code true} if
   * the property is set and empty, or if its value is "true".
   * <p>
   * If this property is set to {@code true}, the parser will remove quotes from the command line
   * arguments, as follows:
   * <ul>
   ...
   * {@code false}, so quotes are respected: quoted strings are treated as a single value that
   * should not be broken up.
   * <p>
   * For example, take a single command line parameter {@code "a,b","x,y"}. With a comma split
   * regex, the default of {@code splitQuotedStrings = false} means that this value will be split
   * into two strings: {@code "a,b"} and {@code "x,y"}. This is usually what you want.
   * </p>
   * <p>
   * If {@code splitQuotedStrings} is set to {@code true}, quotes are not respected, and the value
   * is split up into four parts: the first is {@code "a}, the second is {@code b"}, the third is
   * {@code "x}, and the last part is {@code y"}. This is generally not what you want.
   * </p>
   * 
   * @deprecated Most applications should not change the default. The rare application that
   *             <em>does</em> need to split parameter values without respecting quotes should use
  ...
  /**
   * Sets whether the parser is allowed to split quoted Strings. The default is {@code false}, so
   * quotes are respected: quoted strings are treated as a single value that should not be broken
   * up.
   * <p>
   * For example, take a single command line parameter {@code "a,b","x,y"}. With a comma split
   * regex, the default of {@code splitQuotedStrings = false} means that this value will be split
   ...
   * </p>
   * <p>
   * However, if {@code splitQuotedStrings} is set to {@code true}, quotes are not respected, and
   * the value is split up into four parts: the first is {@code "a}, the second is {@code b"}, the
   * third is {@code "x}, and the last part is {@code y"}. This is generally not what you want.
   * </p>
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
  ...
  /**
   * Sets the end-of-options delimiter that signals that the remaining command line arguments should
   * be treated as positional parameters.
   * 
   * @param delimiter the end-of-options delimiter; must not be {@code null}. The default is
   *        {@code "--"}.
   * @return this {@code CommandLine} object, to allow method chaining
   * @since 3.5
   */
   ...
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its sub-cli and nested sub-subcommands <em>at the moment this method is called</em>. Sub-cli
   * added later will have the default setting. To ensure a setting is applied to all sub-cli, call
   * the setter last, after adding sub-cli.
   * </p>
   * 
  ...
  /**
   * Returns whether the parser interprets the first positional parameter as "end of options" so the
   ...
   * </p>
   * 
   * @param newValue {@code true} if all values following the first positional parameter should be
   ...
   * as it encounters an unmatched option. Unmatched options are arguments that look like an option
   ...
   * it encounters an unmatched option. Unmatched options are arguments that look like an option but
   * are not one of the known options, or positional arguments for which there is no available slots
   * (the command has no positional parameters or their size is limited). The default is
   * {@code false}.
   * <p>
   * Setting this flag to {@code true} automatically sets the
   ...
   * </p>
   * 
   * @param newValue {@code true} when an unmatched option should result in the remaining command
   *        line arguments to be added to the {@linkplain #getUnmatchedArguments()
   ...
   * 
   * @return {@code true} arguments on the command line that resemble an option should be treated as
   *         positional parameters, {@code false} otherwise
   ...
   * </p>
   * 
   * @param newValue the new setting. When {@code true}, arguments on the command line that resemble
   *        an option should be treated as positional parameters.
   * @return this {@code CommandLine} object, to allow method chaining
   * @since 3.0
   * @see #getUnmatchedArguments()
   ...
   * any option or parameter fields. The default is {@code false} and a
   ...
   * {@link #execute(String...) execute} and {@link #executeHelpRequest(ParseResult)
   * executeHelpRequest} methods.
   * <p>
   * Commands can override these defaults with annotations (e.g.
   * {@code @Command(exitCodeOnInvalidInput = 64, exitCodeOnExecutionException = 70)} or
   * programmatically (e.g. {@link CommandSpec#exitCodeOnInvalidInput(int)}).
   * </p>
   * <p>
   * Additionally, there are several mechanisms for cli to return custom exit codes. See the javadoc
   * of the {@link #execute(String...) execute} method for details.
   * </p>
   ...
   * reference, here are a few conventions:
   * </p>
   * <ul>
   * <li><a href="https://en.wikipedia.org/wiki/Exit_status">Wikipedia page on Exit Status</a></li>
   * <li><a href="http://www.faqs.org/docs/abs/HTML/exitcodes.html#EXITCODESREF">Bash exit
   * codes</a></li>
   * <li><a href="https://www.freebsd.org/cgi/man.cgi?query=sysexits&amp;sektion=3">FreeBSD exit
   * codes</a></li>
   * <li><a href="http://www.hiteksoftware.com/knowledge/articles/049.htm">Windows exit
   * codes</a></li>
   * </ul>
   * <h3>Valid Ranges</h3>
   * <p>
   * Note that *nix shells may restrict exit codes to the 0-255 range, DOS seems to allow larger
   * numbers. See this <a href=
  ...
  public static final class ExitCode {
     ...
     * {@link #executeHelpRequest(ParseResult) executeHelpRequest} methods signifying successful
     * termination.
     * <p>
    ...
    /**
     * Return value from the {@link #execute(String...) execute} method signifying internal software
     * error: an exception occurred when invoking the Runnable, Callable or Method user object of a
     * command.
     * <p>
     * The value of this constant is {@value}.
     * </p>
    ...
    /**
     * Return value from the {@link #execute(String...) execute} method signifying command line
     * usage error: user input for the command was incorrect, e.g., the wrong number of arguments, a
  ...
  /**
   * {@code @Command}-annotated classes can implement this interface to specify an exit code that
   * will be returned from the {@link #execute(String...) execute} method when the command is
  ...
  public interface IExitCodeGenerator {
    /**
     * Returns the exit code that should be returned from the {@link #execute(String...) execute}
     * method.
     * 
   ...
   * {@link #execute(String...) execute} method for an exception that occurred during parsing or
   * while invoking the command's Runnable, Callable, or Method.
   * <p>
   * Example usage:
   * </p>
   * 
  ...
  public interface IExitCodeExceptionMapper {
     ...
     * method.
     * 
     * @param exception the exception that occurred during parsing or while invoking the command's
  ...
  private static int mappedExitCode(Throwable t, IExitCodeExceptionMapper mapper,
      int defaultExitCode) {
    try {
   ...
   * {@linkplain CommandLine.Help#defaultColorScheme(CommandLine.Help.Ansi) default color scheme}
   * with {@link Help.Ansi#AUTO Ansi.AUTO}.
   * 
   * @see #execute(String...)
   ...
   * {@linkplain #execute(String...) execution}. Defaults to a PrintWriter wrapper around
   * {@code System.out} unless {@link #setOut(PrintWriter)} was called with a different writer.
   * <p>
   * This method is used by {@link #execute(String...)}. Custom {@link IExecutionStrategy
   * IExecutionStrategy} implementations should also use this writer.
   * </p>
   * <p>
   * By <a href="http://www.gnu.org/prep/standards/html_node/_002d_002dhelp.html">convention</a>,
   * when the user requests help with a {@code --help} or similar option, the usage help message is
   * printed to the standard output stream so that it can be easily searched and paged.
   * </p>
   * 
   * @since 4.0
   */
   ...
   * {@linkplain #execute(String...) execution}. Defaults to a PrintWriter wrapper around
   * {@code System.err}, unless {@link #setErr(PrintWriter)} was called with a different writer.
   * <p>
   * This method is used by {@link #execute(String...)}. {@link IParameterExceptionHandler
   * IParameterExceptionHandler} and {@link IExecutionExceptionHandler IExecutionExceptionHandler}
   * implementations should use this writer to print error messages (which may include a usage help
  ...
  /**
   * Sets the writer to use when printing diagnostic (error) messages during command
   * {@linkplain #execute(String...) execution}.
   * <p>
   * This method is used by {@link #execute(String...)}. {@link IParameterExceptionHandler
   * IParameterExceptionHandler} and {@link IExecutionExceptionHandler IExecutionExceptionHandler}
  ...
  /**
   * Returns the mapper that was set by the application to map from exceptions to exit codes, for
   * use by the {@link #execute(String...) execute} method.
   * 
   * @return the mapper that was {@linkplain #setExitCodeExceptionMapper(IExitCodeExceptionMapper)
   *         set}, or {@code null} if none was set
   * @since 4.0
   */
  ...
  /**
   * Sets the mapper used by the {@link #execute(String...) execute} method to map exceptions to
   * exit codes.
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
  ...
  public CommandLine setExitCodeExceptionMapper(IExitCodeExceptionMapper exitCodeExceptionMapper) {
    this.exitCodeExceptionMapper =
        Assert.notNull(exitCodeExceptionMapper, "exitCodeExceptionMapper");
    for (CommandLine sub : getSubcommands().values()) {
  ...
  /**
   * Sets the execution strategy that the {@link #execute(String...) execute} method should use to
   * invoke the business logic on the user objects of this command and/or the user-specified
   * subcommand(s).
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
  ...
  /**
   * Returns the handler for dealing with invalid user input when the command is
   * {@linkplain #execute(String...) executed}.
   * <p>
   * The default implementation prints an error message describing the problem, followed by either
   * {@linkplain UnmatchedArgumentException#printSuggestions(PrintWriter) suggested alternatives}
   * for mistyped options, or the full {@linkplain #usage(PrintWriter, Help.ColorScheme) usage} help
   * message of the {@linkplain ParameterException#getCommandLine() problematic command}; it then
   * delegates to the {@linkplain #getExitCodeExceptionMapper() exit code execution mapper} for an
   * exit code, with {@link CommandSpec#exitCodeOnInvalidInput() exitCodeOnInvalidInput} as the
   * default exit code.
   * </p>
   * 
  ...
  /**
   * Sets the handler for dealing with invalid user input when the command is
   * {@linkplain #execute(String...) executed}.
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
  ...
  public CommandLine setParameterExceptionHandler(
    ...
    this.parameterExceptionHandler =
        Assert.notNull(parameterExceptionHandler, "parameterExceptionHandler");
    for (CommandLine sub : getSubcommands().values()) {
  ...
  /**
   * Returns the handler for dealing with exceptions that occurred in the {@code Callable},
   * {@code Runnable} or {@code Method} user object of a command when the command was
   * {@linkplain #execute(String...) executed}.
   * <p>
  ...
  /**
   * Sets a custom handler for dealing with exceptions that occurred in the {@code Callable},
   * {@code Runnable} or {@code Method} user object of a command when the command was executed via
   * the {@linkplain #execute(String...) execute} method.
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
   * Subcommands added later will have the default setting. To ensure a setting is applied to all
   ...
   * </p>
   * 
   * @param executionExceptionHandler the handler for dealing with exceptions that occurred in the
   *        business logic when the {@link #execute(String...) execute} method was invoked.
   * @return this CommandLine for method chaining
   * @since 4.0
   */
  public CommandLine setExecutionExceptionHandler(
    ...
    this.executionExceptionHandler =
        Assert.notNull(executionExceptionHandler, "executionExceptionHandler");
    for (CommandLine sub : getSubcommands().values()) {
   ...
   * </pre>
   * <p>
   * All this method does is parse the arguments and populate the annotated fields and methods. The
   * caller is responsible for catching any exceptions, handling requests for usage help or version
   ...
   * and returns an instance of the specified interface. The interface is expected to have annotated
   * getter methods. Picocli will instantiate the interface and the getter methods will return the
   * option and positional parameter values matched on the command line.
   * </p>
   * <p>
   * This is equivalent to
   * </p>
   ...
   * </pre>
   * <p>
   * All this method does is parse the arguments and return an instance whose annotated methods
   * return the specified values. The caller is responsible for catching any exceptions, handling
   * requests for usage help or version information, and invoking the business logic. Applications
   * may be interested in using the {@link #execute(String...)} method instead.
   * </p>
   *
   * @param spec the interface that defines the command specification. This object contains getter
   ...
   * <p>
   * If parsing succeeds, the first element in the returned list is always {@code this CommandLine}
   * object. The returned list may contain more elements if subcommands were
   ...
   *         {@link ParameterException#getCommandLine()} to get the command or subcommand whose user
   *         input was invalid
  ...
  /**
   * Parses the specified command line arguments and returns a list of {@code ParseResult} with the
   * options, positional parameters, and subcommands (if any) that were recognized and initialized
  ...
  /**
   * Returns the result of calling the user object {@code Callable} or invoking the user object
   * {@code Method} after parsing the user input, or {@code null} if this command has not been
   * {@linkplain #execute(String...) executed} or if this {@code CommandLine} is for a subcommand
   * that was not specified by the end user on the command line.
   * <p>
   * <b>Implementation note:</b>
   * </p>
   * <p>
   * It is the responsibility of the {@link IExecutionStrategy IExecutionStrategy} to set this
   * value.
   * </p>
   * 
   * @param <T> type of the result value
   * @return the result of the user object {@code Callable} or {@code Method} (may be {@code null}),
   *         or {@code null} if this (sub)command was not executed
   * @since 4.0
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Clears the {@linkplain #getExecutionResult() execution result} of a previous invocation from
   * this {@code CommandLine} and all subcommands.
   * 
   * @since 4.0
   */
  ...
  public static interface IParseResultHandler {
     ...
     * {@linkplain #parse(String...) parsing} the command line arguments and optionally returns a
     * list of results.
     * 
     ...
     * @throws ParameterException if a help command was invoked for an unknown subcommand. Any
     *         {@code ParameterExceptions} thrown from this method are treated as if this exception
     *         was thrown during parsing and passed to the {@link IExceptionHandler}
     ...
     *         processing failed
     */
    List<Object> handleParseResult(List<CommandLine> parsedCommands, PrintStream out,
        Help.Ansi ansi) throws ExecutionException;
  }
   ...
   * </p>
   * <p>
   * This interface replaces the {@link IParseResultHandler} interface; it takes the parse result as
   * a {@code ParseResult} object instead of a List of {@code CommandLine} objects, and it has the
   * freedom to select the {@link Help.Ansi} style to use and what {@code PrintStreams} to print to.
   * </p>
   * 
  ...
  public static interface IParseResultHandler2<R> {
     ...
     * {@linkplain CommandLine#parseArgs(String...) parsing} the command line arguments and returns
     * a return value.
     * 
     * @param parseResult the {@code ParseResult} that resulted from successfully parsing the
     *        command line arguments
     * @throws ParameterException if a help command was invoked for an unknown subcommand. Any
     *         {@code ParameterExceptions} thrown from this method are treated as if this exception
     *         was thrown during parsing and passed to the {@link IExceptionHandler2}
     * @throws ExecutionException if a problem occurred while processing the parse results; use
     *         {@link ExecutionException#getCommandLine()} to get the command or subcommand where
     *         processing failed
     */
   ...
   * {@link #execute(String...)} method delegates to a
   ...
   * </p>
   * <ul>
   * <li>From the {@code ParseResult}, select which {@code CommandSpec} should be executed. This is
   * especially important for cli that have subcommands.</li>
   * <li>"Execute" the selected {@code CommandSpec}. Often this means invoking a method on the
   * spec's {@linkplain CommandSpec#userObject() user object}.</li>
   * <li>Call {@link CommandLine#setExecutionResult(Object) setExecutionResult} to make the return
   * value of that method invocation available to the application</li>
   * <li>Return an exit code. Common sources of exit values are the invoked method's return value,
   * or the user object if it implements {@link IExitCodeGenerator}.</li>
   * </ul>
   * <p>
   * Implementors that need to print messages to the console should use the {@linkplain #getOut()
   * output} and {@linkplain #getErr() error} PrintWriters, and the {@linkplain #getColorScheme()
   * color scheme} from the CommandLine object obtained from ParseResult's CommandSpec.
   * </p>
   * <p>
   * <b>API Note:</b>
   * </p>
  ...
  public interface IExecutionStrategy {
    /**
     * "Executes" the user input and returns an exit code. Execution often means invoking a method
     * on the selected CommandSpec's {@linkplain CommandSpec#userObject() user object}, and making
     * the return value of that invocation available via
     ...
     * @return an exit code
     * @throws ParameterException if the invoked method on the CommandSpec's user object threw a
     *         ParameterException to signify invalid user input.
     * @throws ExecutionException if any problem occurred while executing the command. Any
     *         exceptions (other than ParameterException) should be wrapped in a ExecutionException
     *         and not thrown as is.
     */
   ...
   * Implementations of this function can be passed to the
   * {@link #parseWithHandlers(IParseResultHandler, PrintStream, Help.Ansi, IExceptionHandler, String...)
   * CommandLine::parseWithHandlers} methods to handle situations when the command line could not be
   * parsed.
   * </p>
   * 
  ...
  public static interface IExceptionHandler {
     ...
     *        command line arguments, and the CommandLine representing the command or subcommand
     *        whose input was invalid
     * @param out the {@code PrintStream} to print help to if requested
     * @param ansi for printing help messages using ANSI styles and colors
     * @param args the command line arguments that could not be parsed
     * @return a list of results, or an empty list if there are no results
     */
    List<Object> handleException(ParameterException ex, PrintStream out, Help.Ansi ansi,
        String... args);
  }
  ...
  public static interface IExceptionHandler2<R> {
    /**
     * Handles a {@code ParameterException} that occurred while {@linkplain #parseArgs(String...)
     * parsing} the command line arguments and optionally returns a list of results.
     * 
     * @param ex the ParameterException describing the problem that occurred while parsing the
     *        command line arguments, and the CommandLine representing the command or subcommand
     ...
     * 
     * @param ex the ExecutionException describing the problem that occurred while executing the
     *        {@code Runnable} or {@code Callable} command, and the CommandLine representing the
     *        command or subcommand that was being executed
   ...
   * Implementors that need to print messages to the console should use the {@linkplain #getOut()
   * output} and {@linkplain #getErr() error} PrintWriters, and the {@linkplain #getColorScheme()
   * color scheme} from the CommandLine object obtained from the exception.
   * </p>
   * <p>
   * <b>Implementation Note:</b>
   * </p>
  ...
  public interface IParameterExceptionHandler {
    /**
     * Handles a {@code ParameterException} that occurred while {@linkplain #parseArgs(String...)
     * parsing} the command line arguments and returns an exit code suitable for returning from
     * {@link #execute(String...)}.
     * 
     * @param ex the ParameterException describing the problem that occurred while parsing the
     *        command line arguments, and the CommandLine representing the command or subcommand
  ...
  /**
   * Classes implementing this interface know how to handle Exceptions that occurred while executing
   * the {@code Runnable}, {@code Callable} or {@code Method} user object of the command.
   * <p>
   * <b>Implementation Requirements:</b>
   * </p>
   * <p>
   ...
   * };
   * int exitCode =
   *     new CommandLine(new App()).setExecutionExceptionHandler(errorHandler).execute(args);
   * </pre>
   * 
  ...
  public interface IExecutionExceptionHandler {
     ...
     * {@code Callable} command and returns an exit code suitable for returning from
     * {@link #execute(String...)}.
     * 
     ...
     * @return an exit code
     */
    int handleExecutionException(Exception ex, CommandLine commandLine, ParseResult parseResult)
        throws Exception;
  }
   ...
   * implementations.
   * <p>
   * Note that {@code AbstractHandler} is a generic type. This, along with the abstract {@code self}
   * method, allows method chaining to work properly in subclasses, without the need for casts. An
   * example subclass can look like this:
   * </p>
   * 
   * <pre>
   * {@code
  ...
  public static abstract class AbstractHandler<R, T extends AbstractHandler<R, T>> {
     ...
     * when the user requests help with a {@code --help} or similar option, the usage help message
     * is printed to the standard output stream so that it can be easily searched and paged.
     * </p>
     */
    ...
    /**
     * Returns the exit code to use as the termination status, or {@code null} (the default) if the
     * handler should not call {@link System#exit(int)} after processing completes.
     * 
     * @see #andExit(int)
     */
    ...
    /**
     * Convenience method for subclasses that returns the specified result object if no exit code
     * was set, or otherwise, if an exit code {@linkplain #andExit(int) was set}, calls
    ...
    /**
     * Convenience method for subclasses that throws the specified ExecutionException if no exit
     * code was set, or otherwise, if an exit code {@linkplain #andExit(int) was set}, prints the
     * stacktrace of the specified exception to the diagnostic error stream and calls
     * {@code System.exit} with the configured exit code to terminate the currently running Java
     * virtual machine.
     */
    ...
    /**
     * Indicates that the handler should call {@link System#exit(int)} after processing completes
     * and sets the exit code to use as the termination status.
     * 
  ...
  public static class DefaultExceptionHandler<R>
    ...
    public List<Object> handleException(ParameterException ex, PrintStream out, Help.Ansi ansi,
        String... args) {
    ...
    /**
     * Prints the message of the specified exception, followed by the usage message for the command
     * or subcommand whose input was invalid, to the stream returned by {@link #err()}.
     * 
     * @param ex the ParameterException describing the problem that occurred while parsing the
     *        command line arguments, and the CommandLine representing the command or subcommand
     *        whose input was invalid
   ...
   * 
   * @param parseResult contains the {@code CommandLine} objects found during parsing; check these
   ...
   * @param out the {@code PrintStream} to print help to if requested
   * @param err the error string to print diagnostic messages to, in addition to the output from the
   *        exception handler
   * @param ansi for printing help messages using ANSI styles and colors
   * @return {@code true} if help was printed, {@code false} otherwise
   * @since 3.0
  ...
  @Deprecated
  public static boolean printHelpIfRequested(List<CommandLine> parsedCommands, PrintStream out,
      PrintStream err, Help.Ansi ansi) {
  ...
  @Deprecated
  public static boolean printHelpIfRequested(List<CommandLine> parsedCommands, PrintStream out,
      PrintStream err, Help.ColorScheme colorScheme) {
    // for backwards compatibility
    for (CommandLine cmd : parsedCommands) {
      cmd.setOut(new PrintWriter(out, true)).setErr(new PrintWriter(err, true))
  ...
  /**
   * Helper method that may be useful when processing the {@code ParseResult} that results from
   * successfully {@linkplain #parseArgs(String...) parsing} command line arguments. This method
   * prints out {@linkplain #usage(PrintWriter, Help.ColorScheme) usage help} to the
   ...
   * {@link CommandSpec#exitCodeOnUsageHelp()} or {@link CommandSpec#exitCodeOnVersionHelp()},
   * respectively. If the command is a {@link Command#helpCommand()} and {@code runnable} or
   * {@code callable}, that command is executed and this method returns
   * {@link CommandSpec#exitCodeOnUsageHelp()}. Otherwise, if none of the specified
   * {@code CommandLine} objects have help requested, this method returns {@code null}.
   * <p>
   ...
   * </p>
   * <p>
   * When an error occurs while processing the help request, it is recommended custom Help cli throw
   * a {@link ParameterException} with a reference to the parent command. This will print the error
   * message and the usage for the parent command, and will use the exit code of the exception
   ...
   *         {@link CommandSpec#exitCodeOnVersionHelp()} if version help was requested, and
   *         {@code null} otherwise
    ...
    for (int i = 0; i < parsedCommands.size(); i++) {
      ...
      if (parsed.isUsageHelpRequested()) {
        ...
        if (parsed.getCommand() instanceof IHelpCommandInitializable2) {
          ...
          ((IHelpCommandInitializable) parsed.getCommand()).init(parsed, colorScheme.ansi,
  ...
  private static List<Object> executeUserObject(CommandLine parsed,
      List<Object> executionResultList) {
    ...
    if (command instanceof Runnable) {
      ...
      try {
        ...
        if (Modifier.isStatic(method.getModifiers())) {
          ...
          executionResult =
              method.invoke(parsed.getCommandSpec().parent().userObject(), parsedArgs);
        } else {
          executionResult =
              method.invoke(parsed.factory.create(method.getDeclaringClass()), parsedArgs);
        }
        parsed.setExecutionResult(executionResult);
        executionResultList.add(executionResult);
        return executionResultList;
        ...
        if (t instanceof ParameterException) {
          ...
          throw new ExecutionException(parsed,
              "Error while calling command (" + command + "): " + t, t);
        }
      } catch (Exception ex) {
        throw new ExecutionException(parsed,
            "Unhandled error while calling command (" + command + "): " + ex, ex);
      }
    }
    throw new ExecutionException(parsed,
   ...
   * their application. To use this method, the annotated object that this {@code CommandLine} is
   * constructed with needs to either implement {@link Runnable}, {@link Callable}, or be a
   * {@code Method} object. See {@link #getCommandMethods(Class, String) getCommandMethods} for a
   * convenient way to obtain a command {@code Method}.
   * <p>
   * This method replaces the {@link #run(Runnable, String...) run},
   * {@link #call(Callable, String...) call} and {@link #invoke(String, Class, String...) invoke}
   ...
   * </p>
   * <p>
   * This method returns an exit code that applications can use to call {@code System.exit}. (The
   * return value of the {@code Callable} or {@code Method} can still be obtained via
   * {@link #getExecutionResult() getExecutionResult}.) If the user object {@code Callable} or
   * {@code Method} returns an {@code int} or {@code Integer}, this will be used as the exit code.
   * Additionally, if the user object implements {@link CommandLine.IExitCodeGenerator
   * IExitCodeGenerator}, an exit code is obtained by calling its {@code getExitCode()} method
   * (after invoking the user object).
   * </p>
   * <p>
   * In the case of multiple exit codes the highest value will be used (or if all values are
   * negative, the lowest value will be used).
   * </p>
   * <p>
   ...
   * </p>
   * <p>
   * If the user specified invalid input, the {@linkplain #getParameterExceptionHandler() parameter
   * exception handler} is invoked. By default this prints an error message and the usage help
   * message, and returns an exit code.
   * </p>
   * <p>
   * If an exception occurred while the user object {@code Runnable}, {@code Callable}, or
   * {@code Method} was invoked, this exception is caught and passed to the
   * {@linkplain #getExecutionExceptionHandler() execution exception handler}. The default
   * {@code IExecutionExceptionHandler} will rethrow this Exception.
   * </p>
   * <p>
   * Any exception thrown from the {@code IParameterExceptionHandler} or
   * {@code IExecutionExceptionHandler} is caught, it stacktrace is printed and is mapped to an exit
   * code, using the following logic:
   * </p>
   * <p>
   * If an {@link CommandLine.IExitCodeExceptionMapper IExitCodeExceptionMapper} is
   * {@linkplain #setExitCodeExceptionMapper(IExitCodeExceptionMapper) configured}, this mapper is
   * used to determine the exit code based on the exception.
   * </p>
   * <p>
   * If an {@code IExitCodeExceptionMapper} is not set, by default this method will return the
   * {@code @Command} annotation's {@link Command#exitCodeOnInvalidInput() exitCodeOnInvalidInput}
   ...
   * </pre>
   * <p>
   * Since {@code execute} is an instance method, not a static method, applications can do
   * configuration before invoking the command. For example:
   * </p>
   * 
   * <pre>
   * {
   *   &#64;code
   *   CommandLine cmd = new CommandLine(new MyCallable()).setCaseInsensitiveEnumValuesAllowed(true) // configure
   *                                                                                                 // a
   *                                                                                                 // non-default
   *                                                                                                 // parser
   *                                                                                                 // option
   ...
   * </pre>
   * <p>
   * If the specified command has subcommands, the {@linkplain RunLast last} subcommand specified on
   * the command line is executed. This can be configured by setting the
   * {@linkplain #setExecutionStrategy(IExecutionStrategy) execution strategy}. Built-in
   * alternatives are executing the {@linkplain RunFirst first} subcommand, or executing
  ...
  /**
   * Command line parse result handler that returns a value. This handler prints help if requested,
   * and otherwise calls {@link #handle(CommandLine.ParseResult)} with the parse result. Facilitates
   ...
   */
  @Deprecated
  public abstract static class AbstractParseResultHandler<R>
     ...
     * @throws ParameterException if the {@link HelpCommand HelpCommand} was invoked for an unknown
     *         subcommand. Any {@code ParameterExceptions} thrown from this method are treated as if
     *         this exception was thrown during parsing and passed to the {@link IExceptionHandler2}
     * @throws ExecutionException if a problem occurred while processing the parse results; client
     *         code can use {@link ExecutionException#getCommandLine()} to get the command or
    ...
    public int execute(ParseResult parseResult) throws ExecutionException {
      ...
      return resolveExitCode(parseResult.commandSpec().exitCodeOnSuccess(), executionResult,
          exitCodeGenerators);
    }
      ...
      for (IExitCodeGenerator generator : exitCodeGenerators) {
        try {
          ...
          if ((exitCode > 0 && exitCode > result)
              || (exitCode < 0 && result <= 0 && exitCode < result)) {
            result = exitCode;
          }
        } catch (Exception ex) {
     ...
     * method, and rethrowing an {@code ExecutionException} that details the problem and captures
  ...
  /**
   * Command line {@linkplain IExecutionStrategy execution strategy} that prints help if requested,
   * and otherwise executes the top-level {@code Runnable} or {@code Callable} command. For use by
   * the {@link #execute(String...) execute} method.
   * 
   * @since 2.0
   */
  ...
  public static class RunFirst extends AbstractParseResultHandler<List<Object>>
     ...
     * {@code Callable} command. Finally, either a list of result objects is returned, or the JVM is
     * terminated if an exit code {@linkplain #andExit(int) was set}. If the top-level command does
     * not implement either {@code Runnable} or {@code Callable}, an {@code ExecutionException} is
     * thrown detailing the problem and capturing the offending {@code CommandLine} object.
     *
     * @param parsedCommands the {@code CommandLine} objects that resulted from successfully parsing
     *        the command line arguments
     * @param out the {@code PrintStream} to print help to if requested
     ...
     * @throws ParameterException if the {@link HelpCommand HelpCommand} was invoked for an unknown
     *         subcommand. Any {@code ParameterExceptions} thrown from this method are treated as if
     *         this exception was thrown during parsing and passed to the {@link IExceptionHandler}
     * @throws ExecutionException if a problem occurred while processing the parse results; use
     *         {@link ExecutionException#getCommandLine()} to get the command or subcommand where
     *         processing failed
     */
     ...
     * command does not implement either {@code Runnable} or {@code Callable} and is not a
     * {@code Method}, an {@code ExecutionException} is thrown detailing the problem and capturing
     * the offending {@code CommandLine} object.
     *
     * @param parseResult the {@code ParseResult} that resulted from successfully parsing the
     *        command line arguments
  ...
  /**
   * Command line {@linkplain IExecutionStrategy execution strategy} that prints help if requested,
   * and otherwise executes the most specific {@code Runnable} or {@code Callable} subcommand. For
   * use by the {@link #execute(String...) execute} method.
   * <p>
   * Something like this:
   * </p>
   ...
   * {
   *   &#64;code
   *   // RunLast implementation: print help if requested, otherwise execute the most specific
   *   // subcommand
  ...
  public static class RunLast extends AbstractParseResultHandler<List<Object>>
     ...
     * {@code Callable} subcommand. Finally, either a list of result objects is returned, or the JVM
     * is terminated if an exit code {@linkplain #andExit(int) was set}. If the last (sub)command
     * does not implement either {@code Runnable} or {@code Callable}, an {@code ExecutionException}
    ...
    public List<Object> handleParseResult(List<CommandLine> parsedCommands, PrintStream out,
      ...
      return returnResultOrExit(executeUserObject(parsedCommands.get(parsedCommands.size() - 1),
          new ArrayList<Object>()));
    }

    /**
     * Executes the most specific {@code Runnable} or {@code Callable} subcommand. If the last
     * (sub)command does not implement either {@code Runnable} or {@code Callable} and is not a
     * {@code Method}, an {@code ExecutionException} is thrown detailing the problem and capturing
     * the offending {@code CommandLine} object.
     *
     * @param parseResult the {@code ParseResult} that resulted from successfully parsing the
    ...
    protected List<Object> handle(ParseResult parseResult) throws ExecutionException {
      List<CommandLine> parsedCommands = parseResult.asCommandLineList();
      return executeUserObject(parsedCommands.get(parsedCommands.size() - 1),
          new ArrayList<Object>());
    }
    ...
    protected List<IExitCodeGenerator> extractExitCodeGenerators(ParseResult parseResult) {
      List<CommandLine> parsedCommands = parseResult.asCommandLineList();
      Object userObject =
          parsedCommands.get(parsedCommands.size() - 1).getCommandSpec().userObject();
  ...
  /**
   * Command line {@linkplain IExecutionStrategy execution strategy} that prints help if requested,
   * and otherwise executes the top-level command and all subcommands as {@code Runnable},
   * {@code Callable} or {@code Method}. For use by the {@link #execute(String...) execute} method.
   * 
   * @since 2.0
   */
  @SuppressWarnings("deprecation")
  public static class RunAll extends AbstractParseResultHandler<List<Object>>
     ...
     * {@code Runnable}, {@code Callable} or {@code Method}. Finally, either a list of result
     * objects is returned, or the JVM is terminated if an exit code {@linkplain #andExit(int) was
     * set}. If any of the {@code CommandLine} cli does not implement either {@code Runnable} or
     * {@code Callable}, an {@code ExecutionException} is thrown detailing the problem and capturing
     * the offending {@code CommandLine} object.
     *
     * @param parsedCommands the {@code CommandLine} objects that resulted from successfully parsing
     *        the command line arguments
     ...
     *         cli: the return values from calling the {@code Callable} cli, {@code null} elements
     *         for cli that implement {@code Runnable}
     * @throws ParameterException if the {@link HelpCommand HelpCommand} was invoked for an unknown
     *         subcommand. Any {@code ParameterExceptions} thrown from this method are treated as if
     *         this exception was thrown during parsing and passed to the {@link IExceptionHandler}
     * @throws ExecutionException if a problem occurred while processing the parse results; use
     ...
     * If any of the {@code CommandLine} cli does not implement either {@code Runnable} or
     * {@code Callable} and is not a {@code Method}, an {@code ExecutionException} is thrown
   ...
   * {@link #run(Runnable, PrintStream, PrintStream, Help.Ansi, String...) run} and
   * {@link #call(Callable, PrintStream, PrintStream, Help.Ansi, String...) call} methods, but with
   * more flexibility and better support for nested subcommands.
   * </p>
   * <p>
   ...
   * </pre>
   * <p>
   * Picocli provides some default handlers that allow you to accomplish some common tasks with very
   * little code. The following handlers are available:
   * </p>
   * <ul>
   ...
   * <li>{@link RunAll} handler prints help if requested, and otherwise executes all recognized cli
   * and subcommands as {@code Runnable} or {@code Callable} tasks.</li>
   * <li>{@link DefaultExceptionHandler} prints the error message followed by usage help</li>
   * </ul>
   * 
   * @param <R> the return type of this handler
   * @param handler the function that will handle the result of successfully parsing the command
   *        line arguments
   * @param args the command line arguments
   * @return an object resulting from handling the parse result or the exception that occurred while
   *         parsing the input
   ...
   */
  @Deprecated
  public List<Object> parseWithHandlers(IParseResultHandler handler, PrintStream out,
      Help.Ansi ansi, IExceptionHandler exceptionHandler, String... args) {
    clearExecutionResults();
    try {
  ...
  /**
   * Tries to {@linkplain #parseArgs(String...) parse} the specified command line arguments, and if
   * successful, delegates the processing of the resulting {@code ParseResult} object to the
   ...
   *         parsing the input
   * @throws ExecutionException if the command line arguments were parsed successfully but a problem
   *         occurred while processing the parse result {@code ParseResult} object; use
   *         {@link ExecutionException#getCommandLine()} to get the command or subcommand where
   *         processing failed
   ...
   * @throws IllegalArgumentException if the specified command object does not have a
   *         {@link Command}, {@link Option} or {@link Parameters} annotation
   */
   ...
   * @param command the object annotated with {@link Command}, {@link Option} and {@link Parameters}
   * @param out the print stream to print the help message to
   * @param colorScheme the {@code ColorScheme} defining the styles for options, parameters and cli
  ...
  /**
   * Delegates to {@link #usage(PrintWriter, Help.ColorScheme)} with the
   * {@linkplain #getColorScheme() configured} color scheme.
   * 
   ...
   * {@code PrintStream}. Delegates construction of the usage help message to the {@link Help} inner
   * class and is equivalent to:
   * 
   * <pre>
   ...
   * <p>
   * To customize the auto-generated sections of the usage help message, like how option details are
   * displayed, instantiate a {@link Help} object and use a {@link Help.TextTable} with more of
   * fewer columns, a custom {@linkplain Help.Layout layout}, and/or a custom option
   * {@linkplain Help.IOptionRenderer renderer} for ultimate control over which aspects of an Option
   * or Field are displayed where.
   * </p>
   * 
  ...
  public void usage(PrintWriter writer, Help.ColorScheme colorScheme) {
    writer
        .print(usage(new StringBuilder(), getHelpFactory().create(getCommandSpec(), colorScheme)));
    writer.flush();
  }

  /**
   * Similar to {@link #usage(PrintStream)}, but returns the usage help message as a String instead
   * of printing it to the {@code PrintStream}.
   * 
   * @since 3.2
   */
  public String getUsageMessage() {
    return usage(new StringBuilder(), getHelpFactory().create(getCommandSpec(), getColorScheme()))
        .toString();
  }
  ...
  public String getUsageMessage(Help.Ansi ansi) {
    return usage(new StringBuilder(),
        getHelpFactory().create(getCommandSpec(), Help.defaultColorScheme(ansi))).toString();
  }

  /**
   * Similar to {@link #usage(PrintStream, Help.ColorScheme)}, but returns the usage help message as
   * a String instead of printing it to the {@code PrintStream}.
   * 
   * @since 3.2
   */
  public String getUsageMessage(Help.ColorScheme colorScheme) {
    return usage(new StringBuilder(), getHelpFactory().create(getCommandSpec(), colorScheme))
        .toString();
  }
  ...
  /**
   * Delegates to {@link #printVersionHelp(PrintWriter, Help.Ansi, Object...)} with the ANSI setting
   * of the {@linkplain #getColorScheme() configured} color scheme.
   * 
  ...
  /**
   * Prints version information from the {@link Command#version()} annotation to the specified
   * {@code PrintWriter}. Each element of the array of version strings is
   * {@linkplain String#format(String, Object...) formatted} with the specified parameters, and
   * printed on a separate line. Both version strings and parameters may contain
   * <a href="http://picocli.info/#_usage_help_with_styles_and_colors">markup for colors and
   * style</a>.
   ...
   */
  @Deprecated
  public static <C extends Callable<T>, T> T call(C callable, PrintStream out, Help.Ansi ansi,
      String... args) {
  ...
  /**
   * Convenience method to allow command line application authors to avoid some boilerplate code in
   * their application. The annotated object needs to implement {@link Callable}.
   * <p>
   ...
   * specified on the command line is executed.
   * </p>
   * 
  ...
  /**
   * Equivalent to {@code new CommandLine(callableClass, factory).execute(args)}, except for the
   * return value.
   * 
   * @param callableClass class of the command to call when {@linkplain #parseArgs(String...)
   *        parsing} succeeds.
   * @param factory the factory responsible for instantiating the specified callable class and
   ...
   * with {@code System.err} for diagnostic error messages, and {@link Help.Ansi#AUTO}.
   * 
   * @param callableClass class of the command to call when {@linkplain #parseArgs(String...)
   *        parsing} succeeds.
   * @param factory the factory responsible for instantiating the specified callable class and
  ...
  @Deprecated
  public static <C extends Callable<T>, T> T call(Class<C> callableClass, IFactory factory,
      PrintStream out, Help.Ansi ansi, String... args) {
    return call(callableClass, factory, out, System.err, ansi, args);
  }

  /**
   * Convenience method to allow command line application authors to avoid some boilerplate code in
   * their application. The specified {@linkplain IFactory factory} will create an instance of the
   * specified {@code callableClass}; use this method instead of
   * {@link #call(Callable, PrintStream, PrintStream, Help.Ansi, String...) call(Callable, ...)} if
   ...
   * {
   *   &#64;code
   *   CommandLine cmd = new CommandLine(callableClass, factory).setOut(myOutWriter()) // System.out
   *                                                                                   // by default
   *       .setErr(myErrWriter()) // System.err by default
   *       .setColorScheme(myColorScheme()); // default color scheme, Ansi.AUTO by default
   *   int exitCode = cmd.execute(args);
  ...
  @Deprecated
  public static <C extends Callable<T>, T> T call(Class<C> callableClass, IFactory factory,
      PrintStream out, PrintStream err, Help.Ansi ansi, String... args) {
    CommandLine cmd = new CommandLine(callableClass, factory);
    List<Object> results = cmd.parseWithHandlers(new RunLast().useOut(out).useAnsi(ansi),
        new DefaultExceptionHandler<List<Object>>().useErr(err).useAnsi(ansi), args);
    return firstElement(results);
   ...
   */
  @Deprecated
  public static <R extends Runnable> void run(R runnable, PrintStream out, Help.Ansi ansi,
      String... args) {
  ...
  /**
   * Convenience method to allow command line application authors to avoid some boilerplate code in
   * their application. The annotated object needs to implement {@link Runnable}.
   * <p>
   * Consider using the {@link #execute(String...)} method instead:
   * </p>
   * 
   ...
   * 
   * @param runnableClass class of the command to run when {@linkplain #parseArgs(String...)
   *        parsing} succeeds.
   * @param factory the factory responsible for instantiating the specified Runnable class and
   *        potentially injecting other components
   * @param args the command line arguments to parse
   ...
   * Convenience method to allow command line application authors to avoid some boilerplate code in
   * their application. The specified {@linkplain IFactory factory} will create an instance of the
   * specified {@code runnableClass}; use this method instead of
   ...
   * {
   *   &#64;code
   *   CommandLine cmd = new CommandLine(runnableClass, factory).setOut(myOutWriter()) // System.out
   *                                                                                   // by default
   *       .setErr(myErrWriter()) // System.err by default
   *       .setColorScheme(myColorScheme()); // default color scheme, Ansi.AUTO by default
   *   int exitCode = cmd.execute(args);
   ...
   * error messages, and {@link Help.Ansi#AUTO}.
   * 
   * @param methodName the {@code @Command}-annotated method to build a {@link CommandSpec} config
   *        from, and run when {@linkplain #parseArgs(String...) parsing} succeeds.
   ...
   * @throws InitializationException if the specified method does not have a {@link Command}
   *         annotation, or if the specified class contains multiple {@code @Command}-annotated
  ...
  /**
   * Delegates to {@link #invoke(String, Class, PrintStream, PrintStream, Help.Ansi, String...)}
   * with the specified stream for requested usage help messages, {@code System.err} for diagnostic
   * error messages, and {@link Help.Ansi#AUTO}.
   * 
   * @param methodName the {@code @Command}-annotated method to build a {@link CommandSpec} config
   *        from, and run when {@linkplain #parseArgs(String...) parsing} succeeds.
   ...
   * Delegates to {@link #invoke(String, Class, PrintStream, PrintStream, Help.Ansi, String...)}
   * with the specified stream for requested usage help messages, {@code System.err} for diagnostic
   * error messages, and the specified Ansi mode.
   * 
   * @param methodName the {@code @Command}-annotated method to build a {@link CommandSpec} config
   *        from, and run when {@linkplain #parseArgs(String...) parsing} succeeds.
   * @param cls the class where the {@code @Command}-annotated method is declared, or a subclass
   ...
   */
  @Deprecated
  public static Object invoke(String methodName, Class<?> cls, PrintStream out, Help.Ansi ansi,
      String... args) {
  ...
  /**
   * Convenience method to allow command line application authors to avoid some boilerplate code in
   * their application. Constructs a {@link CommandSpec} config from the {@code @Option} and
   * {@code @Parameters}-annotated method parameters of the {@code @Command}-annotated method,
   * parses the specified command line arguments and invokes the specified method.
   * <p>
   * Consider using the {@link #execute(String...)} method instead:
   * </p>
   * 
   ...
   * optionally filtered by method name (not {@link Command#name() @Command.name}). Methods have to
   * be either public (inherited) members or be declared by {@code cls}, that is "inherited" static
   * or protected methods will not be picked up.
   *
   * @param cls the class to search for methods annotated with {@code @Command}
   * @param methodName if not {@code null}, return only methods whose method name (not
   ...
   * </ul>
   * <p>
   * The specified converter will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment the converter is
   ...
   * <p>
   * The specified bundle will be registered with this {@code CommandLine} and the full hierarchy of
   * its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
  ...
  /**
   * Returns whether picocli should attempt to detect the terminal size and adjust the usage help
   * message width to take the full terminal width. End users may enable this by setting system
   * property {@code "picocli.usage.width"} to {@code AUTO}, and may disable this by setting this
   * system property to a {@linkplain UsageMessageSpec#width() numeric value}. This feature requires
  ...
  /**
   * Sets whether picocli should attempt to detect the terminal size and adjust the usage help
   * message width to take the full terminal width. The default is {@code false}.
   * <p>
   * The specified setting will be registered with this {@code CommandLine} and the full hierarchy
   * of its subcommands and nested sub-subcommands <em>at the moment this method is called</em>.
   * Subcommands added later will have the default setting. To ensure a setting is applied to all
   ...
   * parsing behaviour. The command name may also be set declaratively with the
   * {@link CommandLine.Command#name()} annotation attribute.
   * 
   ...
   * argument file and its contents should be expanded into separate arguments for each line in the
   * specified file. This property is {@code true} by default.
   * 
   ...
   * file and its contents should be expanded into separate arguments for each line in the specified
   * file. ({@code true} by default.)
   * 
   * @param expandAtFiles whether "argument files" or {@code @files} should be expanded into their
   *        content
   * @return this {@code CommandLine} object, to allow method chaining
  ...
  /**
   * Sets the character that starts a single-line comment or {@code null} if all content of argument
   * files should be interpreted as arguments (without comments). If specified, all characters from
   * the comment character to the end of the line are ignored.
   * 
   * @param atFileCommentChar the character that starts a single-line comment or {@code null}. The
   *        default is {@code '#'}.
   * @return this {@code CommandLine} object, to allow method chaining
  ...
  /**
   * Returns whether to use a simplified argument file format that is compatible with JCommander. In
   * this format, every line (except empty lines and comment lines) is interpreted as a single
   * argument. Arguments containing whitespace do not need to be quoted. When system property
   * {@code "picocli.useSimplifiedAtFiles"} is defined, the system property value overrides the
  ...
  /**
   * Sets whether to use a simplified argument file format that is compatible with JCommander. In
   * this format, every line (except empty lines and comment lines) is interpreted as a single
   * argument. Arguments containing whitespace do not need to be quoted. When system property
   * {@code "picocli.useSimplifiedAtFiles"} is defined, the system property value overrides the
   * programmatically set value.
   * 
   * @param simplifiedAtFiles whether to use a simplified argument file format. The default is
   *        {@code false}.
   * @return this {@code CommandLine} object, to allow method chaining
   ...
   * </p>
   * 
   * @param transformer the {@code INegatableOptionTransformer} used to create negative option
   *        names.
   * @return this {@code CommandLine} object, to allow method chaining
   * @see Option#negatable()
  ...
  public @interface Option {
     ...
     * <p>
     * If an option is required, but a user invokes the program without specifying the required
     * option, a {@link MissingParameterException} is thrown from the {@link #parse(String...)}
     * method.
     * </p>
     * <p>
     * Required options that are part of a {@linkplain ArgGroup group} are required <em>within the
     * group</em>, not required within the command: the group's {@linkplain ArgGroup#multiplicity()
     * multiplicity} determines whether the group itself is required or optional.
     * </p>
     * 
    ...
    /**
     * Description of this option, used when generating the usage documentation. Each element of the
     * array is rendered on a separate line.
     * <p>
     * May contain embedded {@linkplain java.util.Formatter format specifiers} like {@code %n} line
     * separators. Literal percent {@code '%'} characters must be escaped with another {@code %}.
     * </p>
     * <p>
     * The description may contain variables that are rendered when help is requested. The string
     * {@code ${DEFAULT-VALUE}} is replaced with the default value of the option. This is regardless
     * of the command's {@link Command#showDefaultValues() showDefaultValues} setting or the
     * option's {@link #showDefaultValue() showDefaultValue} setting. The string
     * {@code ${COMPLETION-CANDIDATES}} is replaced with the completion candidates generated by
     * {@link #completionCandidates()} in the description for this option. Also, embedded {@code %n}
     ...
     * Previously ignored for single-value fields, from picocli 4.0 a {@code split} regex can only
     * be specified on multi-value options and positional parameters.
     * 
     ...
     * 
     * @return a String that (after type conversion) will be used as the value for this option if
     ...
     * password). Only supported for single-value options and {@code char[]} arrays (no collections,
     * maps or other array types). When running on Java 6 or greater, this will use the
     * {@link Console#readPassword()} API to get a value without echoing input to the console.
     * <p>
     * Best security practice is to use type {@code char[]} instead of {@code String}, and to to
     * null out the array after use.
     * </p>
     * <p>
     * When defined with {@code arity = "0..1"}, the option can also take a value from the command
     * line. (The user will still be prompted if no option parameter was specified on the command
     * line.) This is useful for cli that need to be run interactively as well as in batch mode.
     * </p>
     * 
    ...
    /**
     * When {@link Command#sortOptions() @Command(sortOptions = false)} is specified, this attribute
     * can be used to control the order in which options are listed in the usage help message.
     * 
     * @return the position in the options list at which this option should be shown. Options with a
     *         lower number are shown before options with a higher number. Gaps are allowed.
     * @since 3.9
     */
    int order() default -1;

    /**
     * (Only for boolean options): set this to automatically add a negative version for this boolean
     * option. For example, for a {@code --force} option the negative version would be
     * {@code --no-force}, and for a {@code -XX:+PrintGCDetails} option, the negative version would
     * be {@code -XX:-PrintGCDetails}. The synopsis would show {@code --[no-]force} and
     ...
     * </p>
     * <p>
     * Negative option names used to parse the command line are collected when the command is
     * constructed (so any variables in the option names will be resolved at that time).
     * Documentation strings for negatable options are generated on demand when the usage help
     * message is shown.
     * </p>
     * 
    ...
    /**
     * For options with an optional parameter (for example, {@code arity = "0..1"}), this value is
     * assigned to the annotated element if the option is specified on the command line without an
     * option parameter.
     * <p>
     * This is different from the {@link #defaultValue()}, which is assigned if the option is not
     * specified at all on the command line.
     * </p>
     * <p>
     ...
     * <li>option was specified with parameter on the command line (command line argument value
     * assigned)</li>
     * </ul>
     * <p>
     * This is useful to define options that can function as a boolean "switch" and optionally allow
     * users to provide a (strongly typed) extra parameter value.
     * </p>
     * 
    ...
    /**
     * Optionally specify a custom {@code IParameterConsumer} to temporarily suspend picocli's
     * parsing logic and process one or more command line arguments in a custom manner. This may be
     * useful when passing arguments through to another program.
     * 
     * @since 4.0
     */
  ...
  public @interface Parameters {
    ...
    /**
     * Description of the parameter(s), used when generating the usage documentation. Each element
     * of the array is rendered on a separate line.
     * <p>
     * May contain embedded {@linkplain java.util.Formatter format specifiers} like {@code %n} line
     * separators. Literal percent {@code '%'} characters must be escaped with another {@code %}.
     * </p>
     * <p>
     * The description may contain variables that are rendered when help is requested. The string
     * {@code ${DEFAULT-VALUE}} is replaced with the default value of the positional parameter. This
     * is regardless of the command's {@link Command#showDefaultValues() showDefaultValues} setting
     * or the positional parameter's {@link #showDefaultValue() showDefaultValue} setting. The
     * string {@code ${COMPLETION-CANDIDATES}} is replaced with the completion candidates generated
     * by {@link #completionCandidates()} in the description for this positional parameter. Also,
     ...
     * </p>
     * <p>
     * For single-value parameters, setting {@code arity = "0..1"} makes a positional parameter
     * optional, while setting {@code arity = "1"} makes it required.
     * </p>
     * <p>
     * Required parameters that are part of a {@linkplain ArgGroup group} are required <em>within
     * the group</em>, not required within the command: the group's
     * {@linkplain ArgGroup#multiplicity() multiplicity} determines whether the group itself is
    ...
    /**
     * Optionally specify a custom {@code IParameterConsumer} to temporarily suspend picocli's
     * parsing logic and process one or more command line arguments in a custom manner.
     * 
     * @since 4.0
     */
    Class<? extends IParameterConsumer> parameterConsumer() default NullParameterConsumer.class;
  ...
  /**
   * <p>
   * Fields annotated with {@code @ParentCommand} will be initialized with the parent command of the
   * current subcommand. If the current command does not have a parent command, this annotation has
   * no effect.
   * </p>
   * <p>
   * Parent cli often define options that apply to all the subcommands. This annotation offers a
   * convenient way to inject a reference to the parent command into a subcommand, so the subcommand
   * can access its parent options. For example:
   * </p>
   * 
   * <pre>
  ...
  /**
   * Fields annotated with {@code @Unmatched} will be initialized with the list of unmatched command
   * line arguments, if any. If this annotation is found, picocli automatically sets
   ...
   *     version = "Encrypt version 1.0", footer = "Copyright (c) 2017",
  ...
  public @interface Command {
     ...
     * declaratively like this, you don't need to call the
    ...
    /**
     * Specify whether methods annotated with {@code @Command} should be registered as subcommands
     * of their enclosing {@code @Command} class. The default is {@code true}. For example:
     * 
     * <pre>
     * &#064;Command
     * public class Git {
     ...
     * {@linkplain Option#versionHelp() option} to request version help. Each element of the array
     ...
     * return version information obtained from the JAR manifest, a properties file or some other
     * source.
     * 
     ...
     * options and {@code -V} and {@code --version} {@linkplain Option#versionHelp() versionHelp}
     * options to the options of this command.
     * <p>
    ...
    /**
     * Set this attribute to {@code true} if this subcommand is a help command, and required options
     * and positional parameters of the parent command should not be validation. If a subcommand
     * marked as {@code helpCommand} is specified on the command line, picocli will not validate the
     * parent arguments (so no "missing required option" errors) and the
     * {@link CommandLine#printHelpIfRequested(List, PrintStream, PrintStream, Help.Ansi)} method
     * will return {@code true}.
     * 
     * @return {@code true} if this subcommand is a help command and picocli should not check for
     *         missing required options and positional parameters on the parent command
     * @since 3.0
     */
    ...
    /**
     * Optional summary description of the command, shown before the synopsis. Each element of the
     * array is rendered on a separate line.
     * <p>
     * May contain embedded {@linkplain java.util.Formatter format specifiers} like {@code %n} line
     * separators. Literal percent {@code '%'} characters must be escaped with another {@code %}.
    ...
    /**
     * Set the heading preceding the synopsis text. The default heading is {@code "Usage: "}
     ...
     * {@code "<main> [OPTIONS] [PARAMETERS...] [COMMAND]"}. By default, a detailed synopsis with
    ...
    /**
     * Specify the String to show in the synopsis for the subcommands of this command. The default
     * is {@code "[COMMAND]"}. Ignored if this command has no {@linkplain #subcommands()
     * subcommands}.
     * 
     * @since 4.0
     */
    ...
    /**
     * Optional text to display between the synopsis line(s) and the list of options. Each element
     * of the array is rendered on a separate line.
     * <p>
     * May contain embedded {@linkplain java.util.Formatter format specifiers} like {@code %n} line
     * separators. Literal percent {@code '%'} characters must be escaped with another {@code %}.
    ...
    /**
     * Class that can provide default values dynamically at runtime. An implementation may return
     * default value obtained from a configuration file like a properties file or some other source.
     * 
    ...
    /**
     * Set the heading preceding the subcommands list. The default heading is {@code "Commands:%n"}
    ...
    /**
     * Set {@code hidden=true} if this command should not be included in the list of cli in the
     * usage help of the parent command.
     * 
    ...
    /**
     * If {@code true}, picocli will attempt to detect the terminal width and adjust the usage help
     * message accordingly. End users may enable this by setting system property
     * {@code "picocli.usage.width"} to {@code AUTO}, and may disable this by setting this system
     * property to a {@linkplain UsageMessageSpec#width() numeric value}. This feature requires Java
     * 7 or greater. The default is {@code false}
     * 
     * @see UsageMessageSpec#autoWidth()
     * @since 4.0
     */
    ...
    /**
     * Exit code signifying that an exception occurred when invoking the Runnable, Callable or
     * Method user object of a command. {@value CommandLine.ExitCode#SOFTWARE} by default.
     * 
     * @see #execute(String...)
     * @since 4.0
     */
    ...
    /**
     * Set the heading preceding the exit codes section, may contain {@code "%n"} line separators.
    ...
    /**
     * Set the values to be displayed in the exit codes section as a list of {@code "key:value"}
     * pairs: keys are exit codes, values are descriptions. Descriptions may contain {@code "%n"}
     * line separators.
     * <p>
     * For example:
     * </p>
  ...
  /**
   * A {@code Command} may define one or more {@code ArgGroups}: a group of options, positional
   * parameters or a mixture of the two. Groups can be used to:
   * <ul>
   * <li>define <b>mutually exclusive</b> arguments. By default, options and positional parameters
   * in a group are mutually exclusive. This can be controlled with the {@link #exclusive()
   * exclusive} attribute. Picocli will throw a {@link MutuallyExclusiveArgsException} if the
   * command line contains multiple arguments that are mutually exclusive.</li>
   * <li>define a set of arguments that <b>must co-occur</b>. Set {@link #exclusive() exclusive =
   * false} to define a group of options and positional parameters that must always be specified
   * together. Picocli will throw a {@link MissingParameterException MissingParameterException} if
   * not all the options and positional parameters in a co-occurring group are specified
   * together.</li>
   * <li>create an <b>option section</b> in the usage help message. To be shown in the usage help
   * message, a group needs to have a {@link #heading() heading} (which may come from a
   * {@linkplain #headingKey() resource bundle}). Groups without a heading are only used for
   * validation. Set {@link #validate() validate = false} for groups whose purpose is only to
   * customize the usage help message.</li>
   * <li>define <b>composite repeating argument groups</b>. Groups may contain other groups to
   * create composite groups.</li>
   * </ul>
   * <p>
   * Groups may be optional ({@code multiplicity = "0..1"}), required ({@code multiplicity = "1"}),
   * or repeating groups ({@code multiplicity = "0..*"} or {@code multiplicity = "1..*"}). For a
   * group of mutually exclusive arguments, making the group required means that one of the
   * arguments in the group must appear on the command line, or a {@link MissingParameterException
   * MissingParameterException} is thrown. For a group of co-occurring arguments, all arguments in
   * the group must appear on the command line.
   * </p>
   * <p>
   ...
   * </ul>
   * <p>
   * Below is an example of an {@code ArgGroup} defining a set of dependent options that must occur
   * together. All options are required <em>within the group</em>, while the group itself is
   * optional:
   * </p>
   * 
   * <pre>
  ...
  public @interface ArgGroup {
    /**
     * The heading of this group, used when generating the usage documentation. When neither a
     * {@link #heading() heading} nor a {@link #headingKey() headingKey} are specified, this group
     * is used for validation only and does not change the usage help message.
     */
    String heading() default "__no_heading__";

    /**
     * ResourceBundle key for this group's usage help message section heading. When neither a
     * {@link #heading() heading} nor a {@link #headingKey() headingKey} are specified, this group
     * is used for validation only and does not change the usage help message.
     */
    ...
    /**
     * Determines whether this is a mutually exclusive group; {@code true} by default. If
     * {@code false}, this is a co-occurring group. Ignored if {@link #validate()} is {@code false}.
     */
    boolean exclusive() default true;

    /**
     * Determines how often this group can be specified on the command line; {@code "0..1"}
     * (optional) by default. For a group of mutually exclusive arguments, making the group required
     * {@code multiplicity = "1"} means that one of the arguments in the group must appear on the
     * command line, or a MissingParameterException is thrown. For a group of co-occurring
     * arguments, making the group required means that all arguments in the group must appear on the
     * command line. Ignored if {@link #validate()} is {@code false}.
     */
    String multiplicity() default "0..1";

    /**
     * Determines whether picocli should validate the rules of this group ({@code true} by default).
     * For a mutually exclusive group validation means verifying that no more than one elements of
     * the group is specified on the command line; for a co-ocurring group validation means
     * verifying that all elements of the group are specified on the command line. Set
    ...
    /**
     * Determines the position in the options list in the usage help message at which this group
     * should be shown. Groups with a lower number are shown before groups with a higher number.
     * This attribute is only honored for groups that have a {@link #heading() heading} (or a
     * {@link #headingKey() headingKey} with a non-{@code null} resource bundle value).
     */
    int order() default -1;
  }
   ...
   * {@link Option @Option} or {@link Parameters @Parameters}, String values can be converted to any
   * type for which a {@code ITypeConverter} is registered.
   * </p>
   * <p>
  ...
  public interface IDefaultValueProvider {
    ...
    /**
     * Returns the default value for an option or positional parameter or {@code null}. The returned
     * value is converted to the type of the option/positional parameter via the same type converter
     * used when populating this option/positional parameter from a command line argument.
     * 
   ...
   * custom logic to process the parameters for this option or this position. When an option or
   * positional parameter with a custom {@code IParameterConsumer} is matched on the command line,
   * picocli's internal parser is temporarily suspended, and this object becomes responsible for
  ...
  public interface IParameterConsumer {
    /**
     * Consumes as many of the specified command line arguments as needed by popping them off the
     * specified Stack. Implementors are free to ignore the {@linkplain ArgSpec#arity() arity} of
     * the option or positional parameter, they are free to consume arguments that would normally be
     * matched as other options of the command, and they are free to consume arguments that would
     * normally be matched as an end-of-options delimiter.
     * <p>
     * Implementors are responsible for saving the consumed values; if the user object of the option
     * or positional parameter is a Collection or a Map, a common approach would be to obtain the
     * current instance via the {@link ArgSpec#getValue()}, and add to this instance. If the user
     * object is an array, the implementation would need to create a new array that contains the old
     * values as well as the newly consumed values, and store this array in the user object via the
     * {@link ArgSpec#setValue(Object)}.
     * </p>
     * <p>
     * If the user input is invalid, implementations should throw a {@link ParameterException} with
     * a message to display to the user.
     * </p>
     * <p>
     * When this method returns, the picocli parser will process the remaining arguments on the
     * Stack.
     * </p>
     * 
     * @param args the command line arguments
  ...
  /**
   * Determines the option name transformation of {@linkplain Option#negatable() negatable} boolean
   * options. Making an option negatable has two aspects:
   * <ul>
   * <li>the negative form recognized by the parser while parsing the command line</li>
   * <li>the documentation string showing both the positive and the negative form in the usage help
   * message</li>
   * </ul>
   * <p>
   * Additionally, this transformer controls which names of a negatable option are actually
   * negatable: for example, by default short options like {@code -v} do not have a negative form,
   * even if the same option's long form, {@code --verbose}, may have a negative form,
   * {@code --no-verbose}.
   * </p>
   * 
  ...
  public interface INegatableOptionTransformer {
    /**
     * Returns the negative form of the specified option name for the parser to recognize when
    ...
    /**
     * Returns the documentation string to show in the synopsis and usage help message for the
     * specified option. The returned value should be concise and clearly suggest that both the
     * positive and the negative form are valid option names
     * 
     * @param optionName the option name to create a documentation string for, for example
     *        {@code --force}, or {@code -XX:+<option>}
     * @param cmd the command that the option is part of
     * @return the documentation string for the negatable option, for example {@code --[no-]force},
     *         or {@code -XX:(+|-)<option>}
     */
  ...
  /**
   * A regular expression-based option name transformation for {@linkplain Option#negatable()
   * negatable} options.
   * <p>
   * A common way to negate GNU *nix long options is to prefix them with {@code "no-"}, so for a
   * {@code --force} option the negative version would be {@code --no-force}. Java has the
   * {@code -XX:[+|-]} JVM options, where "Boolean options are turned on with {@code -XX:+<option>}
   * and turned off with {@code -XX:-<option>}". These are the negative forms
   * {@linkplain #createDefault() supported by default} by this class.
   * </p>
   * <p>
   * See the {@link CommandLine.RegexTransformer.Builder} for an example of customizing this to
   * create negative forms for short options.
   * </p>
   * 
   * @since 4.0
   */
  public static class RegexTransformer implements INegatableOptionTransformer {
    ...
    RegexTransformer(RegexTransformer.Builder builder) {
      replacements =
          Collections.unmodifiableMap(new LinkedHashMap<Pattern, String>(builder.replacements));
    ...
    public static class Builder {
      ...
      /**
       * Adds the specified negative replacement and synopsis replacement for the specified regular
       * expression. For example, to add negative forms for short options:
       * <table border="1">
       ...
       *        {@linkplain #makeNegative(String, CommandSpec) negative name} when the option name
       *        matches
       * @param synopsisReplacement the replacement to use to generate a
       *        {@linkplain #makeSynopsis(String, CommandSpec) documentation string} when the option
       *        name matches
      ...
      /**
       * Removes the negative replacement and synopsis replacement for the specified regular
       * expression.
       * 
  ...
  /**
   * Factory for instantiating classes that are registered declaratively with annotation attributes,
   * like {@link Command#subcommands()}, {@link Option#converter()}, {@link Parameters#converter()}
   * and {@link Command#versionProvider()}.
   * <p>
  ...
  public interface IFactory {
     ...
     * @return the instance
     * @throws Exception an exception detailing what went wrong when creating or obtaining the
     *         instance
     */
  ...
  private static class DefaultFactory implements IFactory {
    ...
    static IParameterConsumer createParameterConsumer(IFactory factory,
        Class<? extends IParameterConsumer> cls) {
      return create(factory, cls);
    }
  ...
  public static class Range implements Comparable<Range> {
     ...
     * is 0; for {@link Option options} this is 0 for booleans and 1 for other types, for
     * {@link Parameters parameters} booleans have arity 0, arrays or Collections have arity "0..*",
     * and other types have arity 1.
     * 
    ...
    private static Range defaultArity(IAnnotatedElement member) {
      ...
      return Range.valueOf("1").unspecified(true);// for single-valued fields (incl. boolean
                                                  // positional
                                                  // parameters)
    }
     ...
     * minimum is zero. If the {@code MAX_VALUE} is not numeric, the range is taken to be variable
    ...
    /**
     * Returns {@code true} if this Range is a default value, {@code false} if the user specified
     * this value.
     * 
     * @since 4.0
     */
    ...
    /**
     * Returns the upper bound of this range (inclusive), or {@code Integer.MAX_VALUE} if this range
     * has {@linkplain #isVariable() no upper bound}.
     * 
     * @since 4.0
     */
    public int max() {
    ...
    boolean overlaps(Range index) {
      return contains(index.min) || contains(index.max) || index.contains(min)
          || index.contains(max);
    }
  }
      ...
      if (index.min > min) {
        throw new ParameterIndexGapException(
            "Command definition should have a positional parameter with index=" + min
                + ". Nearest positional parameter '" + positional.paramLabel() + "' has index="
                + index.min);
      }
  ...
  /**
   * This class provides a namespace for classes and interfaces that config concepts and attributes
  ...
  public static final class Model {
    ...
    /**
     * The scope of a binding is the context where the current value should be gotten from or set
     * to. For a field, the scope is the object whose field value to get/set. For a method binding,
     * it is the object on which the method should be invoked.
     * <p>
     * The getter and setter of the scope allow you to change the object onto which the option and
     * positional parameter getters and setters should be applied.
     * </p>
     * 
     * @since 4.0
     */
     ...
     * When an option or positional parameter is matched on the command line, its getter or setter
     * is invoked to capture the value. For example, an option can be bound to a field or a method,
     * and when the option is matched on the command line, the field's value is set or the method is
    ...
    public static interface IGetter {
       ...
       * @throws Exception internally, picocli call sites will catch any exceptions thrown from here
     ...
     * capture the value. For example, an option can be bound to a field or a method, and when the
     * option is matched on the command line, the field's value is set or the method is invoked with
     ...
     * positional parameters and subcommands supported by the command, as well as attributes for the
     * version help message and the usage help message of the command.
     * <p>
     * Picocli views a command line application as a hierarchy of cli: there is a top-level command
     * (usually the Java class with the {@code main} method) with optionally a set of command line
     * options, positional parameters and subcommands. Subcommands themselves can have options,
     * positional parameters and nested sub-subcommands to any level of depth.
     * </p>
     * <p>
     * The object config has a corresponding hierarchy of {@code CommandSpec} objects, each with a
     * set of {@link OptionSpec}, {@link PositionalParamSpec} and {@linkplain CommandLine
     * subcommands} associated with it. This object config is used by the picocli command line
    ...
    public static class CommandSpec {
      ...
      /**
       * Constant Boolean holding the default setting for whether method cli should be added as
       * subcommands: <code>{@value}</code>.
       */
      static final Boolean DEFAULT_IS_ADD_METHOD_SUBCOMMANDS = true;

      /**
       * Constant Boolean holding the default setting for whether variables should be interpolated
       * in String values: <code>{@value}</code>.
       */
      ...
      private final Map<String, OptionSpec> optionsByNameMap =
          new LinkedHashMap<String, OptionSpec>();
      private final Map<String, OptionSpec> negatedOptionsByNameMap =
          new LinkedHashMap<String, OptionSpec>();
      private final Map<Character, OptionSpec> posixOptionsByKeyMap =
          new LinkedHashMap<Character, OptionSpec>();
      ...
      private final List<PositionalParamSpec> positionalParameters =
          new ArrayList<PositionalParamSpec>();
      private final List<UnmatchedArgsBinding> unmatchedArgs =
          new ArrayList<UnmatchedArgsBinding>();
      private final List<IAnnotatedElement> specElements = new ArrayList<IAnnotatedElement>();
      private final List<IAnnotatedElement> parentCommandElements =
          new ArrayList<IAnnotatedElement>();
      ...
      private INegatableOptionTransformer negatableOptionTransformer =
      ...
      /**
       * Creates and returns a new {@code CommandSpec} initialized from the specified associated
       * user object. The specified user object must have at least one {@link Command},
       * {@link Option} or {@link Parameters} annotation.
       * 
       * @param userObject the user object annotated with {@link Command}, {@link Option} and/or
       *        {@link Parameters} annotations.
       * @throws InitializationException if the specified object has no picocli annotations or has
       *         invalid annotations
       */
      ...
      /**
       * Creates and returns a new {@code CommandSpec} initialized from the specified associated
       * user object. If the specified user object has no {@link Command}, {@link Option} or
       * {@link Parameters} annotations, an empty {@code CommandSpec} is returned.
       * 
       * @param userObject the user object annotated with {@link Command}, {@link Option} and/or
       *        {@link Parameters} annotations.
      ...
      void validate() {
        ...
        String wrongType =
            "Non-boolean options like %s should not be marked as '%s=true'. Usually a command has one %s boolean flag that triggers display of the %s. Alternatively, consider using @Command(mixinStandardHelpOptions = true) on your command instead.";
        String multiple =
            "Multiple options %s are marked as '%s=true'. Usually a command has only one %s option that triggers display of the %s. Alternatively, consider using @Command(mixinStandardHelpOptions = true) on your command instead.%n";
      ...
      /**
       * Initializes the usageMessage specification for this command from the specified settings and
       * returns this commandSpec.
       */
       ...
       * {@link UsageMessageSpec#messages(Messages) UsageMessageSpec.messages} to a {@link Messages
       * Messages} object created from this command spec and the specified bundle, and then sets the
       * {@link ArgSpec#messages(Messages) ArgSpec.messages} of all options and positional
       * parameters in this command to the same {@code Messages} instance. Subcommands are not
       * modified.
       * <p>
       * This method is preferable to {@link #resourceBundle(ResourceBundle)} for pre-Java 8
       * </p>
       * 
       * @param resourceBundleBaseName the base name of the ResourceBundle to set, may be
       *        {@code null}
      ...
      public CommandSpec resourceBundleBaseName(String resourceBundleBaseName) {
        ResourceBundle bundle =
            empty(resourceBundleBaseName) ? null : ResourceBundle.getBundle(resourceBundleBaseName);
      ...
      /**
       * Adds the specified subcommand with the specified name. If the specified subcommand does not
       * have a ResourceBundle set, it is initialized to the ResourceBundle of this command spec.
       * 
       * @param name subcommand name - the preferred subcommand name to register the subcommand
       *        under. If {@code null}, the {@linkplain CommandSpec#name() name} of the specified
       *        subcommand is used; if this is also {@code null}, the first
       *        {@linkplain CommandSpec#aliases() alias} is used. When this String is encountered in
       *        the command line arguments, the subcommand is invoked.
       * @param subcommand describes the subcommand to envoke when the name is encountered on the
       *        command line
       * @return this {@code CommandSpec} object for method chaining
       * @throws InitializationException if the specified name is {@code null}, and no alternative
       *         name could be found, or if another subcommand was already registered under the same
       *         name, or if one of the aliases of the specified subcommand was already used by
       *         another subcommand.
       */
       ...
       * 
       * @param name subcommand name - the preferred subcommand name to register the subcommand
       *        under. If {@code null}, the {@linkplain CommandLine#getCommandName() name} of the
       *        specified subcommand is used; if this is also {@code null}, the first
       *        {@linkplain CommandSpec#aliases() alias} is used. When this String is encountered in
       *        the command line arguments, the subcommand is invoked.
       * @param subCommandLine the subcommand to envoke when the name is encountered on the command
       *        line
       * @return this {@code CommandSpec} object for method chaining
       * @throws InitializationException if the specified name is {@code null}, and no alternative
       *         name could be found, or if another subcommand was already registered under the same
      ...
      /**
       * Returns whether method cli should be added as subcommands. True by default. Used by the
       * annotation processor.
       * 
       * @since 4.0
       */
      public boolean isAddMethodSubcommands() {
        return (isAddMethodSubcommands == null) ? DEFAULT_IS_ADD_METHOD_SUBCOMMANDS
            : isAddMethodSubcommands;
      }

      /**
       * Sets whether method cli should be added as subcommands. True by default. Used by the
       * annotation processor.
       * 
       * @since 4.0
       */
      ...
      public boolean interpolateVariables() {
        return (interpolateVariables == null) ? DEFAULT_INTERPOLATE_VARIABLES
       ...
       * command methods (class methods annotated with {@code @Command}) as subcommands.
       * 
       * @param factory the factory used to create instances of subcommands, converters, etc., that
       *        are registered declaratively with annotation attributes
       * @return this {@link CommandSpec} object for method chaining
       * @see #addSubcommand(String, CommandLine)
       * @since 3.7.0
       */
       ...
       * @return this CommandSpec for method chaining
       * @throws DuplicateOptionAnnotationsException if any of the names of the specified option is
       *         the same as the name of another option
       */
        ...
        if (option.negatable()) {
          ...
          for (String name : interpolator.interpolate(option.names())) { // cannot be null or empty
            ...
            if (name.equals(negatedName)) {
              ...
              tracer.debug("Option %s is negatable, registering negative name %s.%n", name,
                  negatedName);
       ...
       * The positional parameter's {@linkplain PositionalParamSpec#description()} may now return
       * Strings from this CommandSpec's {@linkplain UsageMessageSpec#messages() messages}. The
       * positional parameter's {@linkplain PositionalParamSpec#defaultValueString()} may now return
       * Strings from this CommandSpec's {@link CommandSpec#defaultValueProvider()}
      ...
      public CommandSpec addPositional(PositionalParamSpec positional) {
        ...
        if (positional.index().isUnresolved()) {
          positional.index =
              Range.valueOf(interpolator.interpolate(positional.index().originalValue));
      ...
      /**
       * (INCUBATING) Removes the specified option spec or positional parameter spec from the list
       * of configured arguments to expect.
       * 
       ...
       *         {@link ArgGroupSpec}
       * @throws NoSuchElementException if the specified ArgSpec is not part of this
       *         {@code CommandSpec}
       * @since 4.0
       */
      ...
      private static <T extends Object> int remove(ArgSpec arg, Map<T, OptionSpec> map) {
        int result = 0;
        for (Iterator<Map.Entry<T, OptionSpec>> iterator = map.entrySet().iterator(); iterator
            .hasNext();) {
       ...
       *         {@linkplain ArgGroupSpec#parentGroup() ancestors} has already been added
       * @since 4.0
       */
      ...
      private CommandSpec addArgGroup(ArgGroupSpec group, Set<OptionSpec> groupOptions,
        ...
        addGroupArgsToCommand(group, new HashMap<String, ArgGroupSpec>(), groupOptions,
            groupPositionals);
        return this;
      }
        ...
        for (ArgSpec arg : group.args()) {
          if (arg.isOption()) {
            ...
            for (String name : names) {
              ...
              if (other != null && other != group) {
                throw new DuplicateNameException("An option cannot be in multiple groups but "
                    + name + " is in " + group.synopsisUnit() + " and "
                    + added.get(name).synopsisUnit()
       ...
       * @param mixin the mixin whose options and positional parameters and other attributes to add
       *        to this command
       * @return this CommandSpec for method chaining
       */
      public CommandSpec addMixin(String name, CommandSpec mixin) {
        ...
        Set<PositionalParamSpec> positionals =
            new LinkedHashSet<PositionalParamSpec>(mixin.positionalParameters());
      ...
      /**
       * Adds the specified {@code UnmatchedArgsBinding} to the list of config objects to capture
      ...
      /**
       * Adds the specified {@code {@literal @}Spec}-annotated program element to the list of
       * elements for this command.
       * 
       * @return this CommandSpec for method chaining
       * @since 4.0
       */
      ...
      /**
       * Adds the specified {@code {@literal @}ParentCommand}-annotated program element to the list
       * of elements for this command.
       * 
       * @return this CommandSpec for method chaining
       * @since 4.0
       */
      ...
      /**
       * Returns a map of the mixin names to mixin {@code CommandSpec} objects configured for this
       * command.
       * 
      ...
      /**
       * Returns a map of the negated option names to option spec objects configured for this
       * command.
       * 
       ...
       * This does not include options and positional parameters that are part of a
       * {@linkplain ArgGroupSpec group}.
       * 
      ...
      /**
       * Returns the list of {@link UnmatchedArgsBinding UnmatchedArgumentsBindings} configured for
       * this command; each {@code UnmatchedArgsBinding} captures the arguments that could not be
       * matched to any options or positional parameters.
       */
      ...
      /**
       * Returns the list of program elements annotated with {@code {@literal @}Spec} configured for
       * this command.
       * 
       * @since 4.0
       */
      ...
      /**
       * Returns the list of program elements annotated with {@code {@literal @}ParentCommand}
       * configured for this command.
       * 
       * @since 4.0
       */
       ...
       * this command's {@link #name() name}, preceded by the qualified name of the parent command,
       * if any, separated by a space.
       * 
       * @return {@link #DEFAULT_COMMAND_NAME} by default, initialized from {@link Command#name()}
       *         and the parent command if defined.
       * @since 3.0.1
       */
      ...
      /**
       * Returns this command's fully qualified name, which is its {@link #name() name}, preceded by
       * the qualified name of the parent command, if this command has a parent command.
       * 
       * @return {@link #DEFAULT_COMMAND_NAME} by default, initialized from {@link Command#name()}
       *         and the parent command if any.
       * @param separator the string to put between the names of the cli in the hierarchy
       * @since 3.6
       */
       ...
       * specifies an {@linkplain OptionSpec#versionHelp() option} to request version help. This is
       * not part of the usage help message.
       * 
       * @return the version strings generated by the {@link #versionProvider() version provider} if
       *         one is set, otherwise the {@linkplain #version(String...) version literals}
       */
      public String[] version() {
        ...
        return interpolator
            .interpolate(version == null ? UsageMessageSpec.DEFAULT_MULTI_LINE : version);
      }

      /**
       * Returns the version provider for this command, to generate the {@link #version()} strings.
       * 
       * @return the version provider or {@code null} if the version strings should be returned from
       *         the {@linkplain #version(String...) version literals}.
       */
       ...
       * parameters of the parent command should not be validation.
       * 
       * @return {@code true} if this subcommand is a help command and picocli should not check for
       *         missing required options and positional parameters on the parent command
      ...
      /**
       * Returns exit code for successful termination. {@value CommandLine.ExitCode#OK} by default,
       * may be set programmatically or via the {@link Command#exitCodeOnSuccess()
      ...
      /**
       * Returns exit code for command line usage error. {@value CommandLine.ExitCode#USAGE} by
       * default, may be set programmatically or via the {@link Command#exitCodeOnInvalidInput()
      ...
      /**
       * Returns exit code signifying that an exception occurred when invoking the Runnable,
       * Callable or Method user object of a command. {@value CommandLine.ExitCode#SOFTWARE} by
       * default, may be set programmatically or via the
       * {@link Command#exitCodeOnExecutionException() exitCodeOnExecutionException} annotation.
       * 
       * @see #execute(String...)
       * @since 4.0
       */
      public int exitCodeOnExecutionException() {
        return exitCodeOnExecutionException == null ? ExitCode.SOFTWARE
      ...
      /**
       * Returns {@code true} if the standard help options have been mixed in with this command,
       * {@code false} otherwise.
       */
      ...
      public CommandSpec aliases(String... aliases) {
        this.aliases =
            new LinkedHashSet<String>(Arrays.asList(aliases == null ? new String[0] : aliases));
        return this;
      }
      ...
      /**
       * Sets version information literals for this command, to print to the console when the user
       * specifies an {@linkplain OptionSpec#versionHelp() option} to request version help. Only
       * used if no {@link #versionProvider() versionProvider} is set.
       * 
       * @return this CommandSpec for method chaining
       */
       ...
       * 
       * @param versionProvider the version provider to use to generate the version strings, or
       *        {@code null} if the {@linkplain #version(String...) version literals} should be
       *        used.
       * @return this CommandSpec for method chaining
       */
      ...
      /**
       * Sets exit code for command line usage error. {@value CommandLine.ExitCode#USAGE} by
       * default.
       * 
       * @see #execute(String...)
       * @since 4.0
      ...
      /**
       * Sets exit code signifying that an exception occurred when invoking the Runnable, Callable
       * or Method user object of a command. {@value CommandLine.ExitCode#SOFTWARE} by default.
       * 
       * @see #execute(String...)
       * @since 4.0
       */
      ...
      public CommandSpec negatableOptionTransformer(INegatableOptionTransformer newValue) {
        Tracer tracer = new Tracer();
        tracer.debug("Replacing negatableOptionTransformer %s with %s%n",
      ...
      public CommandSpec mixinStandardHelpOptions(boolean newValue) {
        if (newValue) {
          CommandSpec mixin =
              CommandSpec.forAnnotatedObject(new AutoHelpMixin(), new DefaultFactory());
       ...
       * {@link ParserSpec#separator() parser separator}, command name, version, help command,
      ...
      /**
       * Returns the option with the specified name, or {@code null} if no option with that name is
      ...
      boolean resemblesOption(String arg, Tracer tracer) {
        ...
        boolean result = count > 0 && count * 10 >= optionsMap().size() * 9; // at least one prefix
                                                                             // char in
                                                                             // common with 9 out of
                                                                             // 10
                                                                             // options
        if (tracer != null && tracer.isDebug()) {
    ...
    /**
     * Models the usage help message specification and can be used to customize the usage help
     * message.
     * <p>
     ...
     * </ul>
     * <p>
     * The pre-defined sections have getters and setters that return a String (or array of Strings).
     * For example: {@link #description()} and {@link #description(String...)} or {@link #header()}
     * and {@link #header(String...)}.
     * </p>
     * <p>
     * Changing the section order, or adding custom sections can be accomplished with
     * {@link #sectionKeys(List)} and {@link #sectionMap(Map)}. This gives complete freedom on how a
     * usage help message section is rendered, but it also means that the
     * {@linkplain IHelpSectionRenderer section renderer} is responsible for all aspects of
     ...
     * {@link CommandLine.Help.Ansi#string(String)} and {@link CommandLine.Help.Ansi#text(String)}
     ...
     *   sectionMap.put(SECTION_KEY_SYNOPSIS, help -> help.synopsis(help.synopsisHeadingLength())); // e.g.
     *                                                                                              // <cmd>
     *                                                                                              // [OPTIONS]
     *                                                                                              // <subcmd>
     *                                                                                              // [COMMAND-OPTIONS]
     *                                                                                              // [ARGUMENTS]
     *   sectionMap.put(SECTION_KEY_DESCRIPTION_HEADING, help -> help.descriptionHeading()); // e.g.
     *                                                                                       // %nDescription:%n%n
     *   sectionMap.put(SECTION_KEY_DESCRIPTION, help -> help.description()); // e.g. {"Converts foos to
     *                                                                        // bars.", "Use
     *                                                                        // options to control
     *                                                                        // conversion mode."}
     *   sectionMap.put(SECTION_KEY_PARAMETER_LIST_HEADING, help -> help.parameterListHeading()); // e.g.
     *                                                                                            // %nPositional
     *                                                                                            // parameters:%n%n
     *   sectionMap.put(SECTION_KEY_PARAMETER_LIST, help -> help.parameterList()); // e.g. [FILE...] the
     *                                                                             // files to convert
     *   sectionMap.put(SECTION_KEY_OPTION_LIST_HEADING, help -> help.optionListHeading()); // e.g.
     *                                                                                      // %nOptions:%n%n
     *   sectionMap.put(SECTION_KEY_OPTION_LIST, help -> help.optionList()); // e.g. -h, --help displays
     *                                                                       // this help and
     *                                                                       // exits
     *   sectionMap.put(SECTION_KEY_COMMAND_LIST_HEADING, help -> help.commandListHeading()); // e.g.
     *                                                                                        // %nCommands:%n%n
     *   sectionMap.put(SECTION_KEY_COMMAND_LIST, help -> help.commandList()); // e.g. add adds the frup
     *                                                                         // to the frooble
    ...
    public static class UsageMessageSpec {
       ...
       * {@linkplain IHelpSectionRenderer section renderer} for the Header Heading section. The
       * default renderer for this section calls {@link Help#headerHeading(Object...)}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Header section. The default
       * renderer for this section calls {@link Help#header(Object...)}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Synopsis Heading section. The
       * default renderer for this section calls {@link Help#synopsisHeading(Object...)}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Synopsis section. The default
       * renderer for this section calls {@link Help#synopsis(int)}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Description Heading section. The
       * default renderer for this section calls {@link Help#descriptionHeading(Object...)}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Description section. The default
       * renderer for this section calls {@link Help#description(Object...)}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Parameter List Heading section.
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Parameter List section. The
       * default renderer for this section calls {@link Help#parameterList()}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Option List Heading section. The
       * default renderer for this section calls {@link Help#optionListHeading(Object...)}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Option List section. The default
       * renderer for this section calls {@link Help#optionList()}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Subcommand List Heading section.
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Subcommand List section. The
       * default renderer for this section calls {@link Help#commandList()}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Exit Code List Heading section.
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Exit Code List section. The
       * default renderer for this section calls {@link Help#exitCodeList()}.
       * 
       * @since 4.0
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Footer Heading section. The
       * default renderer for this section calls {@link Help#footerHeading(Object...)}.
       * 
       * @since 3.9
       */
      ...
      /**
       * {@linkplain #sectionKeys() Section key} to {@linkplain #sectionMap() control} the
       * {@linkplain IHelpSectionRenderer section renderer} for the Footer section. The default
       * renderer for this section calls {@link Help#footer(Object...)}.
       * 
       * @since 3.9
       */
      ...
      private final static int DEFAULT_SYNOPSIS_INDENT = -1; // by default, fall back to aligning to
                                                             // the synopsis
                                                             // heading
      ...
      /**
       * Constant Boolean holding the default setting for whether to attempt to adjust the width to
       * the terminal width: <code>{@value}</code>.
       */
      ...
      /**
       * Constant Boolean holding the default setting for whether to show default values in the
       * usage help message: <code>{@value}</code>.
       */
      static final Boolean DEFAULT_SHOW_DEFAULT_VALUES = Boolean.FALSE;

      /**
       * Constant Boolean holding the default setting for whether this command should be listed in
       * the usage help of the parent command: <code>{@value}</code>.
       */
      static final Boolean DEFAULT_HIDDEN = Boolean.FALSE;

      /**
       * Constant Boolean holding the default setting for whether line breaks should take wide CJK
       * characters into account: <code>{@value}</code>.
       */
      ...
      private List<String> sectionKeys =
          Collections.unmodifiableList(Arrays.asList(SECTION_KEY_HEADER_HEADING, SECTION_KEY_HEADER,
              SECTION_KEY_SYNOPSIS_HEADING, SECTION_KEY_SYNOPSIS, SECTION_KEY_DESCRIPTION_HEADING,
              SECTION_KEY_DESCRIPTION, SECTION_KEY_PARAMETER_LIST_HEADING,
              SECTION_KEY_PARAMETER_LIST, SECTION_KEY_OPTION_LIST_HEADING, SECTION_KEY_OPTION_LIST,
              SECTION_KEY_COMMAND_LIST_HEADING, SECTION_KEY_COMMAND_LIST,
              SECTION_KEY_EXIT_CODE_LIST_HEADING, SECTION_KEY_EXIT_CODE_LIST,
      ...
      private int getSysPropertyWidthOrDefault(int defaultWidth, boolean detectTerminalSize) {
        if (detectTerminalSize) {
          ...
          return cachedTerminalWidth < 0 ? defaultWidth
              : Math.max(cachedTerminalWidth, MINIMUM_USAGE_WIDTH);
        }
        ...
        try {
          ...
          if (width < MINIMUM_USAGE_WIDTH) {
            new Tracer().warn(
                "Invalid picocli.usage.width value %d. Using minimum usage width %d.%n", width,
                MINIMUM_USAGE_WIDTH);
          ...
          public void run() {
            ...
            try {
              ...
              Method redirectError =
                  ProcessBuilder.class.getDeclaredMethod("redirectError", redirectClass);
      ...
      /**
       * Returns whether picocli should attempt to detect the terminal size and adjust the usage
       * help message width to take the full terminal width. End users may enable this by setting
       * system property {@code "picocli.usage.width"} to {@code AUTO}, and may disable this by
       * setting this system property to a {@linkplain #width() numeric value}. This feature
       * requires Java 7 or greater. The default is {@code false}.
       * 
      ...
      /**
       * Given a character, is this character considered to be a CJK character? Shamelessly stolen
       * from <a href=
      ...
      /**
       * Returns the section keys in the order that the usage help message should render the
       * sections. This ordering may be modified with the {@link #sectionKeys(List) sectionKeys
       * setter}. The default keys are (in order):
       * <ol start="0">
       * <li>{@link UsageMessageSpec#SECTION_KEY_HEADER_HEADING SECTION_KEY_HEADER_HEADING}</li>
       * <li>{@link UsageMessageSpec#SECTION_KEY_HEADER SECTION_KEY_HEADER}</li>
       * <li>{@link UsageMessageSpec#SECTION_KEY_SYNOPSIS_HEADING SECTION_KEY_SYNOPSIS_HEADING}</li>
      ...
      /**
       * Returns the map of section keys and renderers used to construct the usage help message. The
       * usage help message can be customized by adding, replacing and removing section renderers
       * from this map. Sections can be reordered with the {@link #sectionKeys(List) sectionKeys
       * setter}. Sections that are either not in this map or not in the list returned by
       * {@link #sectionKeys() sectionKeys} are omitted.
       * 
       * @see #sectionKeys
       * @since 3.9
       */
      ...
      /**
       * Sets the map of section keys and renderers used to construct the usage help message to a
      ...
      private String[] arr(String[] localized, String[] value, String[] defaultValue) {
        return interpolate(
            localized != null ? localized : (value != null ? value.clone() : defaultValue));
      }
       ...
       * subcommands, the first header line is displayed in the list of cli. Values are initialized
       * from {@link Command#header()} if the {@code Command} annotation is present, otherwise this
       * is an empty array and the help message has no header. Applications may programmatically set
       ...
       * the 2nd line and subsequent lines of a multi-line synopsis should be aligned to the end of
       * the command name. The default value of this attribute is {@code 0.5}. If the length of the
       * synopsis heading plus the length of the fully qualified command name exceeds this fraction
       * of the width, the 2nd and subsequent rows of a multi-line synopsis will be aligned to the
      ...
      /**
       * Returns the indentation to use on the 2nd line and subsequent lines of a multi-line
       * synopsis when the length of the synopsis heading and the fully qualified command name
       * exceed the {@link #width()} times the {@link #synopsisAutoIndentThreshold()}, {@code -1} by
       * default. A negative value for this option means that the 2nd line and subsequent lines are
       * aligned to the synopsis heading length. A positive value means the exact number of spaces
       ...
       * between the synopsis and the options list. Initialized from {@link Command#description()}
       * if the {@code Command} annotation is present, otherwise this is an empty array and the help
      ...
      /**
       * Returns whether the options list in the usage help message should show default values for
       * all non-boolean options.
       */
      ...
      /**
       * Returns the optional heading preceding the exit codes section, may contain {@code "%n"}
       * line separators. {@code ""} (empty string) by default.
       */
      public String exitCodeListHeading() {
        return str(resourceStr("usage.exitCodeListHeading"), exitCodeListHeading,
            DEFAULT_SINGLE_VALUE);
      }

      /**
       * Returns an unmodifiable map with values to be displayed in the exit codes section: keys are
       * exit codes, values are descriptions. Descriptions may contain {@code "%n"} line separators.
       * Callers may be interested in the {@link UsageMessageSpec#keyValuesMap(String...)
       * keyValuesMap} method for creating a map from a list of {@code "key:value"} Strings.
       * <p>
       * This may be configured in a resource bundle by listing up multiple {@code "key:value"}
       * pairs. For example:
       * </p>
       * 
       * <pre>
       ...
       * </pre>
       * 
       * @return an unmodifiable map with values to be displayed in the exit codes section, or an
       *         empty map if no exit codes are {@linkplain #exitCodeList(Map) registered}.
      ...
      public Map<String, String> exitCodeList() {
        ...
        Map<String, String> result =
            keyValuesMap(arr(bundleValues, exitCodeListStrings, DEFAULT_MULTI_LINE));
        return result == null ? Collections.<String, String>emptyMap()
            : Collections.unmodifiableMap(result);
      }

      /**
       * Creates and returns a {@code Map} that contains an entry for each specified String that is
       * in {@code "key:value"} format.
       * 
       * @param entries the strings to process; values that are not in {@code "key:value"} format
       *        are ignored
      ...
      /**
       * Sets the optional header lines displayed at the top of the help message. For subcommands,
       * the first header line is displayed in the list of cli.
       * 
       * @return this UsageMessageSpec for method chaining
       */
      ...
      /**
       * Sets the fraction of the usage help {@link #width()} that is the threshold up to which the
       * 2nd line and subsequent lines of a multi-line synopsis should be aligned to the end of the
       * command name. The default value of this attribute is {@code 0.5}. If the length of the
       * synopsis heading plus the length of the fully qualified command name exceeds this fraction
       * of the width, the 2nd and subsequent rows of a multi-line synopsis will be aligned to the
       * {@link #synopsisIndent()} instead of the end of the command name.
       * 
       ...
       * @return this UsageMessageSpec for method chaining
       * @throws IllegalArgumentException if the specified value is less than 0.0 or greater than
       *         0.9
       * @since 4.0
       */
      public UsageMessageSpec synopsisAutoIndentThreshold(double newValue) {
        if (newValue < 0 || newValue > MAX_SYNOPSIS_AUTO_INDENT_THRESHOLD) {
          throw new IllegalArgumentException(
              "synopsisAutoIndentThreshold must be between 0.0 and 0.9 (inclusive), but was "
                  + newValue);
        }
       ...
       * {@link #synopsisAutoIndentThreshold()} fraction of the {@link #width()}, {@code -1} by
       * default. A negative value for this option means that the 2nd line and subsequent lines are
       * aligned to the synopsis heading length. A positive value means the exact number of spaces
       * to indent for the 2nd line and subsequent lines of the synopsis.
       * 
      ...
      /**
       * Sets whether the synopsis line(s) should show an abbreviated synopsis without detailed
       * option names.
       * 
       * @return this UsageMessageSpec for method chaining
       */
      ...
      /**
       * Sets the optional heading preceding the exit codes section, may contain {@code "%n"} line
       * separators. {@code ""} (empty string) by default.
       * 
       * @since 4.0
       */
      ...
      /**
       * Sets the values to be displayed in the exit codes section: keys are exit codes, values are
       * descriptions. Descriptions may contain {@code "%n"} line separators.
       * <p>
       * This may be configured in a resource bundle by listing up multiple {@code "key:value"}
       * pairs. For example:
       * </p>
      ...
      /**
       * Returns whether line breaks should take wide Chinese, Japanese and Korean characters into
       * account for line-breaking purposes.
       * 
       * @return true if wide Chinese, Japanese and Korean characters are counted as double the size
       *         of other characters for line-breaking purposes
       * @since 4.0
       */
      ...
      /**
       * Sets whether line breaks should take wide Chinese, Japanese and Korean characters into
       * account, and returns this UsageMessageSpec.
       * 
       * @param adjustForWideChars if true, wide Chinese, Japanese and Korean characters are counted
       *        as double the size of other characters for line-breaking purposes
       * @since 4.0
       */
      ...
      void initFromMixin(UsageMessageSpec mixin, CommandSpec commandSpec) {
        ...
        if (initializable(exitCodeList, mixin.exitCodeList(), Collections.emptyMap())
          ...
          exitCodeList =
              Collections.unmodifiableMap(new LinkedHashMap<String, String>(mixin.exitCodeList()));
        }
    ...
    public static class ParserSpec {
      ...
      /**
       * Returns true if options with attached arguments should not consume subsequent arguments and
       * should not validate arity. The default is {@code false}.
       */
      ...
      /**
       * Returns true if exceptions during parsing should be collected instead of thrown. Multiple
       * errors may be encountered during parsing. These can be obtained from
      ...
      /**
       * Sets whether exceptions during parsing should be collected instead of thrown. Multiple
       * errors may be encountered during parsing. These can be obtained from
       * {@link ParseResult#errors()}.
       * 
       * @since 3.2
      ...
      /**
       * Sets whether arguments should be {@linkplain ArgSpec#splitRegex() split} first before any
       * further processing. If true, the original argument will only be split into as many parts as
       * allowed by max arity.
       */
      ...
      public String toString() {
        return String.format(
            ...
            useSimplifiedAtFiles, endOfOptionsDelimiter, limitSplit,
            aritySatisfiedByAttachedOptionParam, toggleBooleanFlags,
            unmatchedOptionsArePositionalParams, collectErrors, caseInsensitiveEnumValuesAllowed,
            trimQuotes, splitQuotedStrings);
      }
    ...
    public abstract static class ArgSpec {
      ...
      private <T extends Builder<T>> ArgSpec(Builder<T> builder) {
        ...
        showDefaultValue =
            builder.showDefaultValue == null ? Help.Visibility.ON_DEMAND : builder.showDefaultValue;
       ...
       * If this argument is part of a {@linkplain ArgGroup group}, this method returns whether this
       * argument is required <em>within the group</em> (so it is not necessarily a required
      ...
      /**
       * Returns the description of this option or positional parameter, after all variables have
       * been rendered, including the {@code ${DEFAULT-VALUE}} and {@code ${COMPLETION-CANDIDATES}}
       * variables. Use {@link CommandSpec#interpolateVariables(Boolean)} to switch off variable
       * expansion if needed.
       * <p>
       * If a resource bundle has been {@linkplain ArgSpec#messages(Messages) set}, this method will
       * first try to find a value in the resource bundle: If the resource bundle has no entry for
       * the {@code fully qualified commandName + "." + descriptionKey} or for the unqualified
       * {@code descriptionKey}, an attempt is made to find the option or positional parameter
       * description using any of the {@linkplain #getAdditionalDescriptionKeys() additional
       * description keys}, first with the {@code fully qualified commandName + "."} prefix, then
       * without.
       * </p>
       * 
      ...
      /**
       * Subclasses should override to return a collection of additional description keys that may
       * be used to find description text for this option or positional parameter in the resource
       * bundle.
       * 
      ...
      private String[] expandVariables(String[] desc) {
        ...
        String fallbackValueString = isOption() ? ((OptionSpec) this).fallbackValue : ""; // interpolate
                                                                                          // later
      ...
      /**
       * Returns the {@code ITypeInfo} that can be used both at compile time (by annotation
       * processors) and at runtime.
       * 
       * @since 4.0
       */
      ...
      /**
       * Returns the default value to assign if this option or positional parameter was not
       * specified on the command line, before splitting and type conversion. This method returns
       * the programmatically set value; this may differ from the default value that is actually
       * used: if this ArgSpec is part of a CommandSpec with a {@link IDefaultValueProvider},
       * picocli will first try to obtain the default value from the default value provider, and
       * this method is only called if the default provider is {@code null} or returned a
       * {@code null} value.
       * 
       * @return the programmatically set default value of this option/positional parameter,
       *         returning {@code null} means this option or positional parameter does not have a
       *         default
       * @see CommandSpec#defaultValueProvider()
       * @see OptionSpec#fallbackValue()
       */
      ...
      /**
       * Returns the default value String for the purpose of displaying it in the description,
       * without interpolating variables.
       * 
      ...
      /**
       * Returns the default value String displayed in the description; interpolating variables if
       * specified. If this ArgSpec is part of a CommandSpec with a {@link IDefaultValueProvider},
       * this method will first try to obtain the default value from the default value provider; if
       * the provider is {@code null} or if it returns a {@code null} value, then next any value set
       * to {@link ArgSpec#defaultValue()} is returned, and if this is also {@code null}, finally
       * the {@linkplain ArgSpec#initialValue() initial value} is returned.
       * 
       * @param interpolateVariables whether to interpolate variables in the {@code defaultValue}
       *        attribute of this ArgSpec
       * @see CommandSpec#defaultValueProvider()
       * @see ArgSpec#defaultValue()
       * @since 4.0
       */
      public String defaultValueString(boolean interpolateVariables) {
        // implementation note: don't call this.defaultValue(), that will interpolate variables too
        // soon!
      ...
      private String defaultValueFromProvider() {
        ...
        try {
          ...
          fromProvider =
              defaultValueProvider == null ? null : defaultValueProvider.defaultValue(this);
        } catch (Exception ex) {
       ...
       * and process one or more command line arguments in a custom manner, or {@code null}. An
       * example of when this may be useful is when passing arguments through to another program.
       * 
       * @since 4.0
       */
      ...
      /**
       * Returns the {@link IScope} that determines on which object to set the value (or from which
       * object to get the value) of this argument.
       */
      public IScope scope() {
        return scope;
      }
      ...
      /**
       * Returns {@code true} if this argument's {@link #type()} is an array, a {@code Collection}
       * or a {@code Map}, {@code false} otherwise.
       */
      ...
      /**
       * Returns the groups this option or positional parameter belongs to, or {@code null} if this
       * option is not part of a group.
       * 
       * @since 4.0
       */
       ...
       *         conversion. For map properties, {@code "key=value"} values are split into the key
       *         and the value part.
       */
      ...
      /**
       * Returns the typed command line arguments matched by this option or positional parameter
       * spec.
       * 
       ...
       *         without value, the values have not been {@linkplain #splitRegex() split}, and for
       *         map properties values may look like {@code "key=value"}
       */
       ...
       * 
       * @param usageHelpShowDefaults whether the command's UsageMessageSpec is configured to show
       *        default values.
       */
      ...
      String[] splitValue(String value, ParserSpec parser, Range arity, int consumed) {
        ...
        return debug(splitRespectingQuotedStrings(value, limit, parser, this, splitRegex()),
            "Split", value);
      }
      ...
      // @since 3.7
      private static String[] splitRespectingQuotedStrings(String value, int limit,
          ParserSpec parser, ArgSpec argSpec, String splitRegex) {
        ...
        // if value was 'a,b,"c,d",e' -> splittable now contains 'a,b,"",e', and quotedValues
        // contains ['c,d']
      ...
      private static String restoreQuotedValues(String part, Queue<String> quotedValues,
          ParserSpec parser) {
        StringBuilder result = new StringBuilder();
      ...
      abstract static class Builder<T extends Builder<T>> {
          ...
          if (factory != null) {
            ...
            if (!NoCompletionCandidates.class.equals(option.completionCandidates())) {
              completionCandidates =
                  DefaultFactory.createCompletionCandidates(factory, option.completionCandidates());
            }
            if (!NullParameterConsumer.class.equals(option.parameterConsumer())) {
              parameterConsumer =
                  DefaultFactory.createParameterConsumer(factory, option.parameterConsumer());
            }
          }
        }
        ...
        Builder(Parameters parameters, IAnnotatedElement source, IFactory factory) {
          ...
          if (parameters == null) {
            ...
            paramLabel =
                inferLabel(parameters.paramLabel(), source.getName(), source.getTypeInfo());
            ...
            if (factory != null) { // annotation processors will pass a null factory
              ...
              if (!NullParameterConsumer.class.equals(parameters.parameterConsumer())) {
                parameterConsumer =
                    DefaultFactory.createParameterConsumer(factory, parameters.parameterConsumer());
              }
            }
          }
        }
         ...
         * 
         * @return type information that does not require {@code Class} objects and be constructed
        ...
        /**
         * Returns the {@link IScope} that determines where the setter sets the value (or the getter
         ...
         * 
         * @param types the element type(s) when the {@link #type()} is a generic {@code Collection}
        ...
        /**
         * Sets the parameterConsumer for this option or positional parameter, and returns this
         * builder.
         * 
         * @since 4.0
         */
         ...
         * 
         * @param propertyType the type of this option or parameter. For multi-value options and
         *        positional parameters this can be an array, or a (sub-type of) Collection or Map.
         */
         ...
         * 
         * @param typeInfo type information that does not require {@code Class} objects and be
        ...
        /**
         * Sets the user object associated with this option or positional parameters, and returns
         * this builder.
         * 
        ...
        /**
         * Sets the {@link IScope} that targets where the setter sets the value, and returns this
         * builder.
         */
     ...
     * {@linkplain CommandSpec command}, including whether it is required or optional, the option
     * parameters supported (or required) by the option, and attributes for the usage help message
     * describing the option.
     * <p>
     * An option has one or more names. The option is matched when the parser encounters one of the
     * option names in the command line arguments. Depending on the option's {@link #arity() arity},
     * the parser may expect it to have option parameters. The parser will call
     * {@link #setValue(Object) setValue} on the matched option for each of the option parameters
     * encountered.
     * </p>
     * <p>
     ...
     * {@link #getValue() getValue} and modify the contents of this data structure. (In the case of
     * arrays, the array is replaced with a new instance with additional elements.)
     * </p>
     * <p>
     * Before calling the setter, picocli converts the option parameter value from a String to the
     * option parameter's type.
     * </p>
     * <ul>
     * <li>If a option-specific {@link #converters() converter} is configured, this will be used for
     * type conversion. If the option's type is a {@code Map}, the map may have different types for
     * its keys and its values, so {@link #converters() converters} should provide two converters:
     * one for the map keys and one for the map values.</li>
     * <li>Otherwise, the option's {@link #type() type} is used to look up a converter in the list
     * of {@linkplain CommandLine#registerConverter(Class, ITypeConverter) registered converters}.
     * For multi-value options, the {@code type} may be an array, or a {@code Collection} or a
     * {@code Map}. In that case the elements are converted based on the option's
     * {@link #auxiliaryTypes() auxiliaryTypes}. The auxiliaryType is used to look up the
     * converter(s) to use to convert the individual parameter values. Maps may have different types
     * for its keys and its values, so {@link #auxiliaryTypes() auxiliaryTypes} should provide two
     * types: one for the map keys and one for the map values.</li>
     * </ul>
     * <p>
     * {@code OptionSpec} objects are used by the picocli command line interpreter and help message
     * generator. Picocli can construct an {@code OptionSpec} automatically from fields and methods
     * with {@link Option @Option} annotations. Alternatively an {@code OptionSpec} can be
     * constructed programmatically.
     * </p>
     * <p>
     * When an {@code OptionSpec} is created from an {@link Option @Option} -annotated field or
     * method, it is "bound" to that field or method: this field is set (or the method is invoked)
     * when the option is matched and {@link #setValue(Object) setValue} is called. Programmatically
     * constructed {@code OptionSpec} instances will remember the value passed to the
     * {@link #setValue(Object) setValue} method so it can be retrieved with the {@link #getValue()
     * getValue} method. This behaviour can be customized by installing a custom {@link IGetter} and
     * {@link ISetter} on the {@code OptionSpec}.
     * </p>
     * 
     * @since 3.0
     */
    public static class OptionSpec extends ArgSpec implements IOrdered {
      ...
      private OptionSpec(Builder builder) {
        ...
        // throw new InitializationException("Option " + longestName() + " is not a boolean so
        // should not be
      ...
      /**
       * Returns a new Builder initialized with the attributes from this {@code OptionSpec}. Calling
       * {@code build} immediately will return a copy of this {@code OptionSpec}.
       * 
      ...
      /**
       * Returns the additional lookup keys for finding description lines in the resource bundle for
       * this option.
       * 
       * @return option names (after variable interpolation), without leading hyphens, slashes and
       *         other non-Java identifier characters.
       * @since 4.0
       */
      @Override
      ...
      /**
       * Returns the position in the options list in the usage help message at which this option
       * should be shown. Options with a lower number are shown before options with a higher number.
       * This attribute is only honored if {@link UsageMessageSpec#sortOptions()} is {@code false}
       * for this command.
       * 
       * @see Option#order()
       * @since 3.9
      ...
      /**
       * Returns whether a negative version for this boolean option is automatically added. The form
       * of the negative name is determined by the {@link INegatableOptionTransformer}.
       * 
       * @see Option#negatable()
       * @since 4.0
       */
      ...
      /**
       * Returns the fallback value for this option: the value that is assigned for options with an
       * optional parameter (for example, {@code arity = "0..1"}) if the option was specified on the
       * command line without parameter.
       * 
      ...
      public boolean equals(Object obj) {
        ...
        boolean result =
            super.equalsImpl(other) && help == other.help && usageHelp == other.usageHelp
                && versionHelp == other.versionHelp && order == other.order
                && negatable == other.negatable && Assert.equals(fallbackValue, other.fallbackValue)
      ...
      public static class Builder extends ArgSpec.Builder<Builder> {
        ...
        /**
         * Returns whether a negative version for this boolean option is automatically added. The
         * form of the negative name is determined by the {@link INegatableOptionTransformer}.
         * 
         * @see Option#negatable()
         * @since 4.0
         */
        ...
        /**
         * Returns the fallback value for this option: the value that is assigned for options with
         * an optional parameter if the option was specified on the command line without parameter.
         * 
         * @see Option#fallbackValue()
         * @since 4.0
         */
        ...
        /**
         * Returns the position in the options list in the usage help message at which this option
         * should be shown. Options with a lower number are shown before options with a higher
         * number. This attribute is only honored if {@link UsageMessageSpec#sortOptions()} is
         * {@code false} for this command.
         * 
         * @see Option#order()
         * @since 3.9
         */
        ...
        /**
         * Sets whether this option disables validation of the other arguments, and returns this
         * builder.
         */
        ...
        /**
         * Sets whether this option allows the user to request version information, and returns this
         * builder.
         */
        ...
        /**
         * Sets whether a negative version for this boolean option is automatically added, and
         * returns this builder.
         * 
         * @since 4.0
         */
        ...
        /**
         * Sets the fallback value for this option: the value that is assigned for options with an
         * optional parameter if the option was specified on the command line without parameter, and
         * returns this builder.
         * 
         * @see Option#fallbackValue()
         * @since 4.0
        ...
        /**
         * Sets the position in the options list in the usage help message at which this option
         * should be shown, and returns this builder.
         * 
         * @since 3.9
         */
     ...
     * {@linkplain CommandSpec command}, including whether it is required or optional, and
     * attributes for the usage help message describing the positional parameter.
     * <p>
     * Positional parameters have an {@link #index() index} (or a range of indices). A positional
     * parameter is matched when the parser encounters a command line argument at that index. Named
     * options and their parameters do not change the index counter, so the command line can contain
     * a mixture of positional parameters and named options.
     * </p>
     * <p>
     ...
     * structure. (In the case of arrays, the array is replaced with a new instance with additional
     * elements.)
     * </p>
     * <p>
     * Before calling the setter, picocli converts the positional parameter value from a String to
     * the parameter's type.
     * </p>
     * <ul>
     * <li>If a positional parameter-specific {@link #converters() converter} is configured, this
     * will be used for type conversion. If the positional parameter's type is a {@code Map}, the
     * map may have different types for its keys and its values, so {@link #converters() converters}
     * should provide two converters: one for the map keys and one for the map values.</li>
     * <li>Otherwise, the positional parameter's {@link #type() type} is used to look up a converter
     * in the list of {@linkplain CommandLine#registerConverter(Class, ITypeConverter) registered
     * converters}. For multi-value positional parameters, the {@code type} may be an array, or a
     * {@code Collection} or a {@code Map}. In that case the elements are converted based on the
     * positional parameter's {@link #auxiliaryTypes() auxiliaryTypes}. The auxiliaryType is used to
     * look up the converter(s) to use to convert the individual parameter values. Maps may have
     ...
     * </ul>
     * <p>
     * {@code PositionalParamSpec} objects are used by the picocli command line interpreter and help
     * message generator. Picocli can construct a {@code PositionalParamSpec} automatically from
     * fields and methods with {@link Parameters @Parameters} annotations. Alternatively a
     ...
     * -annotated field or method, it is "bound" to that field or method: this field is set (or the
     * method is invoked) when the position is matched and {@link #setValue(Object) setValue} is
     * called. Programmatically constructed {@code PositionalParamSpec} instances will remember the
     * value passed to the {@link #setValue(Object) setValue} method so it can be retrieved with the
     * {@link #getValue() getValue} method. This behaviour can be customized by installing a custom
     * {@link IGetter} and {@link ISetter} on the {@code PositionalParamSpec}.
     * </p>
     * 
     * @since 3.0
     */
    public static class PositionalParamSpec extends ArgSpec {
      ...
      private void initCapacity() {
        capacity =
            builderCapacity == null ? Range.parameterCapacity(arity(), index) : builderCapacity;
      }
       ...
       * {@code PositionalParamSpec}. Calling {@code build} immediately will return a copy of this
      ...
      /**
       * Returns an index or range specifying which of the command line arguments should be assigned
       * to this positional parameter.
       * 
      ...
      public static class Builder extends ArgSpec.Builder<Builder> {
        ...
        /**
         * Sets the index or range specifying which of the command line arguments should be assigned
         * to this positional parameter, and returns this builder.
         */
    ...
    public interface IOrdered {
      /**
       * Returns the position in the options list in the usage help message at which this element
       * should be shown. Elements with a lower number are shown before elements with a higher
       * number. For options, this attribute is only honored if
       * {@link UsageMessageSpec#sortOptions()} is {@code false} for this command. For argument
       * groups, this attribute is only honored for groups that have a {@link ArgGroup#heading()
    ...
    /**
     * The {@code ArgGroupSpec} class models a {@link ArgGroup group} of arguments (options,
     * positional parameters or a mixture of the two).
     * 
     * @see ArgGroup
     * @since 4.0
     */
    public static class ArgGroupSpec implements IOrdered {
      ...
      /**
       * Returns whether this is a mutually exclusive group; {@code true} by default. If
       * {@code false}, this is a co-occurring group. Ignored if {@link #validate()} is
       * {@code false}.
       * 
      ...
      /**
       * Returns the multiplicity of this group: how many occurrences it may have on the command
       * line; {@code "0..1"} (optional) by default. A group can be made required by specifying a
       * multiplicity of {@code "1"}. For a group of mutually exclusive arguments, being required
       * means that one of the arguments in the group must appear on the command line, or a
       * MissingParameterException is thrown. For a group of co-occurring arguments, being required
       * means that all arguments in the group must appear on the command line. Ignored if
      ...
      /**
       * Returns whether picocli should validate the rules of this group: for a mutually exclusive
       * group this means that no more than one arguments in the group is specified on the command
       * line; for a co-ocurring group this means that all arguments in the group are specified on
       * the command line. {@code true} by default.
       * 
      ...
      /**
       * Returns the position in the options list in the usage help message at which this group
       * should be shown. Groups with a lower number are shown before groups with a higher number.
       * This attribute is only honored for groups that have a {@link #heading() heading} (or a
       * {@link #headingKey() headingKey} with a non-{@code null} resource bundle value).
       */
      ...
      /**
       * Returns the heading of this group (may be {@code null}), used when generating the usage
       * documentation.
       * 
      ...
      /**
       * Returns the heading key of this group (may be {@code null}), used to get the heading from a
       * resource bundle.
       * 
      ...
      /**
       * Returns the parent group that this group is part of, or {@code null} if this group is not
       * part of a composite.
       */
      ...
      /**
       * Returns {@code true} if this group is a subgroup (or a nested sub-subgroup, to any level of
       * depth) of the specified group, {@code false} otherwise.
       * 
       * @param group the group to check if it contains this group
       * @return {@code true} if this group is a subgroup or a nested sub-subgroup of the specified
       *         group
       */
      ...
      /**
       * Returns the {@link IGetter} that is responsible for supplying the value of the annotated
       * program element associated with this group.
       */
      public IGetter getter() {
        return getter;
      }
      ...
      /**
       * Returns the {@link ISetter} that is responsible for modifying the value of the annotated
       * program element associated with this group.
       */
      public ISetter setter() {
        return setter;
      ...
      /**
       * Returns the {@link IScope} that determines where the setter sets the value (or the getter
       * gets the value) of the annotated program element associated with this group.
       */
      public IScope scope() {
        return scope;
      }
      ...
      public String synopsis() {
        return synopsisText(new Help.ColorScheme.Builder(Help.Ansi.OFF).build(),
            new HashSet<ArgSpec>()).toString();
      }

      String synopsisUnit() {
        Help.ColorScheme colorScheme = new Help.ColorScheme.Builder(Help.Ansi.OFF).build();
        return synopsisUnitText(colorScheme,
            rawSynopsisUnitText(colorScheme, new HashSet<ArgSpec>())).toString();
      }

      /**
       * Returns the synopsis of this group.
       * 
       * @param colorScheme the color scheme to use for options and positional parameters in this
       *        group and subgroups
       * @param outparam_groupArgs all options and positional parameters in the groups this method
       *        generates a synopsis for; these options and positional parameters should be excluded
       *        from appearing elsewhere in the synopsis
      ...
      private Text rawSynopsisUnitText(Help.ColorScheme colorScheme,
      ...
      private Text concatPositionalText(Text text, Help.ColorScheme colorScheme,
        ...
        if (!positionalParam.hidden()) {
          Text label = createLabelRenderer(positionalParam.commandSpec).renderParameterLabel(
      ...
      public boolean equals(Object obj) {
        ...
        return exclusive == other.exclusive && Assert.equals(multiplicity, other.multiplicity)
            && validate == other.validate && order == other.order
            && Assert.equals(heading, other.heading) && Assert.equals(headingKey, other.headingKey)
            && Assert.equals(subgroups, other.subgroups) && Assert.equals(args, other.args);
      }
      ...
      public String toString() {
        ...
        return "ArgGroup[exclusive=" + exclusive + ", multiplicity=" + multiplicity + ", validate="
            + validate + ", order=" + order + ", args=[" + ArgSpec.describe(args())
            + "], headingKey=" + quote(headingKey) + ", heading=" + quote(heading) + ", subgroups="
            + subgroups + "]";
      }
      ...
      void tryInitUserObject(CommandLine commandLine) throws Exception {
        ...
        if (typeInfo() != null) {
          ...
          Object userObject =
              DefaultFactory.create(commandLine.factory, typeInfo().getAuxiliaryTypes()[0]);
          tracer.debug("Created %s, invoking setter %s with scope %s%n", userObject, setter(),
              scope());
          ...
          for (ArgSpec arg : args()) {
            ...
            arg.scope().set(userObject); // flip the actual user object for the arg (and all other
                                         // args in
            ...
            commandLine.interpreter
                .applyDefault(commandLine.getCommandSpec().defaultValueProvider(), arg);
            commandLine.interpreter.parseResultBuilder.isInitializingDefaultValues = false;
          }
          for (ArgGroupSpec subgroup : subgroups()) {
            tracer.debug(
                "Setting scope for subgroup %s with setter=%s in group %s to user object %s%n",
                subgroup.synopsis(), subgroup.setter(), synopsis(), userObject);
            subgroup.scope().set(userObject); // flip the actual user object for the arg (and all
                                              // other args
        ...
        if (typeInfo().isCollection()) {
          ...
          if (c == null) {
            ...
            Collection<Object> c2 =
                (Collection<Object>) DefaultFactory.create(factory, typeInfo.getType());
            setter().set(c = c2);
          }
          (c).add(userObject);
      ...
      ParseResult.GroupValidationResult validateArgs(CommandLine commandLine,
          Collection<ArgSpec> matchedArgs) {
        ...
        return validate(commandLine, presentCount, haveMissing, someButNotAllSpecified,
            exclusiveElements, requiredElements, missingElements);
      }
      ...
      public static class Builder {
        ...
        public Builder updateArgGroupAttributes(ArgGroup group) {
          return this.heading(group.heading()).headingKey(group.headingKey())
              .exclusive(group.exclusive()).multiplicity(group.multiplicity())
              .validate(group.validate()).order(group.order());
        }
         ...
         * multiplicity of {@code "1"}. For a group of mutually exclusive arguments, being required
         * means that one of the arguments in the group must appear on the command line, or a
         * MissingParameterException is thrown. For a group of co-occurring arguments, being
         * required means that all arguments in the group must appear on the command line. Ignored
         * if {@link #validate()} is {@code false}.
         * 
         * @see ArgGroup#multiplicity()
         */
        public Range multiplicity() {
        ...
        /**
         * Sets the multiplicity of this group: how many occurrences it may have on the command
         * line; {@code "0..1"} (optional) by default. A group can be made required by specifying a
         * multiplicity of {@code "1"}. For a group of mutually exclusive arguments, being required
         * means that one of the arguments in the group must appear on the command line, or a
         * MissingParameterException is thrown. For a group of co-occurring arguments, being
        ...
        /**
         * Sets whether picocli should validate the rules of this group: for a mutually exclusive
         * group this means that no more than one arguments in the group is specified on the command
         * line; for a co-ocurring group this means that all arguments in the group are specified on
         * the command line. {@code true} by default.
         * 
        ...
        /**
         * Sets the position in the options list in the usage help message at which this group
         * should be shown, and returns this builder.
         */
        public Builder order(int order) {
          this.order = order;
        ...
        /**
         * Sets the heading of this group (may be {@code null}), used when generating the usage
         * documentation.
         * 
         * @see ArgGroup#heading()
         */
        ...
        /**
         * Sets the type info for the annotated program element associated with this group, and
         * returns this builder.
         * 
         * @param newValue type information that does not require {@code Class} objects and be
         *        constructed both at runtime and compile time
         */
        ...
        /**
         * Sets the {@link IGetter} that is responsible for getting the value of the annotated
         * program element associated with this group, and returns this builder.
         */
        ...
        /**
         * Sets the {@link ISetter} that is responsible for modifying the value of the annotated
         * program element associated with this group, and returns this builder.
         */
        ...
        /**
         * Sets the {@link IScope} that targets where the setter sets the value of the annotated
         * program element associated with this group, and returns this builder.
         */
        ...
        /**
         * Adds the specified argument to the list of options and positional parameters that depend
         * on this group.
         */
    ...
    /**
     * This class allows applications to specify a custom binding that will be invoked for unmatched
     * arguments. A binding can be created with a {@code ISetter} that consumes the unmatched
     * arguments {@code String[]}, or with a {@code IGetter} that produces a
    ...
    public static class UnmatchedArgsBinding {
       ...
       * {@code Collection<String>} that the unmatched arguments can be added to.
       * 
       * @param getter supplies a {@code Collection<String>} that the unmatched arguments can be
       *        added to.
       */
      ...
      private UnmatchedArgsBinding(IGetter getter, ISetter setter) {
        ...
        try {
          ...
          new Tracer().debug("Could not obtain initial value for unmatched from %s%n",
              initialValueHolder);
        }
      }
      ...
      void clear() {
        ...
        try {
          ...
          throw new PicocliException(String.format(
              "Could not invoke setter (%s) with initial value: %s", initialValueHolder, ex), ex);
        }
      }
    }

    /**
     * Command method parameter, similar to java.lang.reflect.Parameter (not available before Java
     * 8).
     * 
     * @since 4.0
     */
    ...
    /**
     * Encapculates type information for an option or parameter to make this information available
     * both at runtime and at compile time (when {@code Class} values are not available). Most of
     * the methods in this interface (but not all!) are safe to use by annotation processors.
     * 
     * @since 4.0
     */
    public interface ITypeInfo {
      ...
      /**
       * Returns type information of components or elements of a {@link #isMultiValue() multivalue}
       * type.
       */
      ...
      /**
       * Returns the class that the option or parameter value should be converted to when matched on
       * the command line. This method is <em>not</em> safe for annotation processors to use.
       * 
      ...
      /**
       * Returns the component class of an array, or the parameter type of a generic Collection, or
       * the parameter types of the key and the value of a generic Map. This method is <em>not</em>
       * safe for annotation processors to use.
       * 
    ...
    static class RuntimeTypeInfo implements ITypeInfo {
      ...
      RuntimeTypeInfo(Class<?> type, Class<?>[] auxiliaryTypes,
          List<String> actualGenericTypeArguments) {
        this.type = Assert.notNull(type, "type");
        this.auxiliaryTypes = Assert.notNull(auxiliaryTypes, "auxiliaryTypes").clone();
        this.actualGenericTypeArguments =
            actualGenericTypeArguments == null ? Collections.<String>emptyList()
      ...
      public static ITypeInfo create(Class<?> type, Class<?>[] annotationTypes, Type genericType,
          Range arity, Class<?> defaultType, boolean interactive) {
      ...
      public static ITypeInfo create(Class<?> type, Class<?>[] auxiliaryTypes,
          List<String> actualGenericTypeArguments, Range arity, Class<?> defaultType,
          boolean interactive) {
        if (type == null) {
        ...
        if (auxiliaryTypes == null || auxiliaryTypes.length == 0) {
          ...
          } else if (Collection.class.isAssignableFrom(type)) { // type is a collection but element
                                                                // type is unspecified
            auxiliaryTypes = new Class<?>[] {interactive ? char[].class : String.class}; // use
                                                                                         // String
                                                                                         // elements
          } else if (Map.class.isAssignableFrom(type)) { // type is a map but element type is
                                                         // unspecified
            auxiliaryTypes = new Class<?>[] {String.class, String.class}; // use String keys and
                                                                          // String
                                                                          // values
          } else {
    ...
    /**
     * Internal interface to allow annotation processors to construct a command config at compile
     * time.
     * 
     * @since 4.0
     */
    ...
    static class TypedMember implements IAnnotatedElement {
      ...
      static boolean isAnnotated(AnnotatedElement e) {
        return false || e.isAnnotationPresent(Option.class)
            || e.isAnnotationPresent(Parameters.class) || e.isAnnotationPresent(ArgGroup.class)
            || e.isAnnotationPresent(Unmatched.class) || e.isAnnotationPresent(Mixin.class)
            || e.isAnnotationPresent(Spec.class) || e.isAnnotationPresent(ParentCommand.class);
      }
        ...
        if (isGetter) {
          ...
          if (Proxy.isProxyClass(proxy.getClass())) {
            PicocliInvocationHandler handler =
                (PicocliInvocationHandler) Proxy.getInvocationHandler(proxy);
      ...
      public String getToString() {
        ...
        return (accessible instanceof Field ? "field "
            : accessible instanceof Method ? "method "
                : accessible.getClass().getSimpleName() + " ")
     ...
     * with support for String arrays and qualified keys: keys that may or may not be prefixed with
     ...
     * </pre>
     * <p>
     * Resources for multiple cli can be specified in a single ResourceBundle. Keys and their value
     * can be shared by multiple cli (so you don't need to repeat them for every command), but keys
     * can be prefixed with {@code fully qualified command name + "."} to specify different values
     * for different cli. The most specific key wins. For example:
     * </p>
     * 
     * <pre>
    ...
    public static class Messages {
      ...
      public Messages(CommandSpec spec, String baseName, ResourceBundle rb) {
        ...
        this.rb = rb;
        this.keys = keys(rb);
        new Tracer().debug("Created Messages from resourceBundle[base=%s] for command '%s' (%s)%n",
       ...
       * @return a Messages object with the specified CommandSpec and the ResourceBundle of the
       *         specified Messages object
       */
       ...
       * 
       * @param key unqualified resource bundle key. This method will first try to find a value by
       *        qualifying the key with the command's fully qualified name, and if not found, it
       *        will try with the unqualified key.
       * @param defaultValue value to return if the resource bundle is null or empty, or if no value
       ...
       * specified default value if not found. Multi-line strings can be specified in the resource
       * bundle with {@code key.0}, {@code key.1}, {@code key.2}, etc.
       * 
       * @param key unqualified resource bundle key. This method will first try to find a value by
       *        qualifying the key with the command's fully qualified name, and if not found, it
       *        will try with the unqualified key.
       * @param defaultValues value to return if the resource bundle is null or empty, or if no
       *        value was found by the qualified or unqualified key
       * @return the String array value found in the resource bundle for the specified key, or the
       *         specified default value
       */
    ...
    private static class CommandReflection {
      static ArgGroupSpec extractArgGroupSpec(IAnnotatedElement member, IFactory factory,
          CommandSpec commandSpec, boolean annotationsAreMandatory) throws Exception {
      ...
      static CommandSpec extractCommandSpec(Object command, IFactory factory,
        ...
        result.mixinStandardHelpOptions(mixinStandardHelpOptions); // #377 Standard help options
                                                                   // should be added
                                                                   // last
      ...
      private static Object[] getOrCreateInstance(Class<?> cls, Object command, IFactory factory,
          Tracer t) {
      ...
      private static void initSubcommands(Command cmd, Class<?> cls, CommandSpec parent,
          IFactory factory, Stack<Class<?>> hierarchy) {
        for (Class<?> sub : cmd.subcommands()) {
          ...
          if (hierarchy.contains(sub)) {
            throw new InitializationException(cmd.name() + " (" + cls.getName()
                + ") has a subcommand (" + sub.getName() + ") that is a subclass of itself");
          }
          try {
            if (Help.class == sub) {
              throw new InitializationException(
      ...
      private static boolean initFromAnnotatedFields(IScope scope, Class<?> cls,
          CommandSpec receiver, ArgGroupSpec.Builder groupBuilder, IFactory factory) {
        ...
        for (Method method : cls.getDeclaredMethods()) {
          result |=
              initFromAnnotatedTypedMembers(TypedMember.createIfAnnotated(method, scope, receiver),
                  receiver, groupBuilder, factory);
        }
        return result;
      }
      ...
      private static boolean initFromAnnotatedTypedMembers(TypedMember member,
        ...
        if (member.isMixin()) {
          assertNoDuplicateAnnotations(member, Mixin.class, Option.class, Parameters.class,
              Unmatched.class, Spec.class, ArgGroup.class);
        ...
        if (member.isArgGroup()) {
          assertNoDuplicateAnnotations(member, ArgGroup.class, Spec.class, Parameters.class,
              Option.class, Unmatched.class, Mixin.class);
          if (groupBuilder != null) {
        ...
        if (member.isUnmatched()) {
          assertNoDuplicateAnnotations(member, Unmatched.class, Mixin.class, Option.class,
              Parameters.class, Spec.class, ArgGroup.class);
          if (groupBuilder != null) {
      ...
      private static boolean initFromMethodParameters(IScope scope, Method method,
          CommandSpec receiver, ArgGroupSpec.Builder groupBuilder, IFactory factory) {
        boolean result = false;
        int optionCount = 0;
      ...
      private static void validateArgSpecMember(TypedMember member) {
        ...
        if (member.isOption()) {
          assertNoDuplicateAnnotations(member, Option.class, Unmatched.class, Mixin.class,
              Parameters.class, Spec.class, ArgGroup.class);
        } else {
          assertNoDuplicateAnnotations(member, Parameters.class, Option.class, Unmatched.class,
              Mixin.class, Spec.class, ArgGroup.class);
        }
        ...
        if (Modifier.isFinal(field.getModifiers())
          ...
          throw new InitializationException("Constant (final) primitive and String fields like "
              + field + " cannot be used as " + (member.isOption() ? "an @Option" : "a @Parameter")
      ...
      private static void validateArgGroupSpec(ArgGroupSpec result, boolean hasArgAnnotation,
          String className) {
      ...
      private static void validateInjectSpec(TypedMember member) {
        ...
        assertNoDuplicateAnnotations(member, Spec.class, Parameters.class, Option.class,
            Unmatched.class, Mixin.class, ArgGroup.class);
      ...
      private static UnmatchedArgsBinding buildUnmatchedForMember(final IAnnotatedElement member) {
        ...
        if (!(info.getClassName().equals(String[].class.getName()) || (info.isCollection() && info
            .getActualGenericTypeArguments().equals(Arrays.asList(String.class.getName()))))) {
          throw new InitializationException(
    ...
    static class Interpolator {
      ...
      public String interpolate(String original) {
        ...
        String result2 =
            result1.replaceAll("\\$\\{COMMAND-FULL-NAME}", commandSpec.qualifiedName());
        if (commandSpec.parent() != null) {
          String tmp =
              result2.replaceAll("\\$\\{PARENT-COMMAND-NAME}", commandSpec.parent().name());
          result2 = tmp.replaceAll("\\$\\{PARENT-COMMAND-FULL-NAME}",
              commandSpec.parent().qualifiedName());
        }
        String result =
            resolveLookups(result2, new HashSet<String>(), new HashMap<String, String>());
        return result;
      }
      ...
      private String resolveLookups(String text, Set<String> visited,
        ...
        for (String lookupKey : lookups.keySet()) {
          ...
          while ((startPos = findOpeningDollar(text, prefix, startPos)) >= 0) {
            ...
            String value =
                resolved.containsKey(prefix + actualKey) ? resolved.get(prefix + actualKey)
  ...
  public static class ParseResult {
    ...
    /**
     * Returns the top-level container for the {@link ArgGroupSpec ArgGroupSpec} match or matches
     * found.
     * <p>
     * If the user input was a valid combination of group arguments, the returned list should
     * contain a single {@linkplain GroupMatch match}. Details of the
     * {@linkplain GroupMatchContainer matched groups} encountered on the command line can be
     * obtained via its {@link GroupMatch#matchedSubgroups() matchedSubgroups()} method. The
     * top-level match returned by this method contains no
     * {@linkplain GroupMatch#matchedValues(ArgSpec) matched arguments}.
     * </p>
     * <p>
     * If the returned list contains more than one {@linkplain GroupMatch match}, the user input was
     * invalid: the maximum {@linkplain ArgGroup#multiplicity() multiplicity} of a group was
     * exceeded, and the parser created an extra {@code match} to capture the values. Usually this
     * results in a {@link ParameterException ParameterException} being thrown by the {@code parse}
     * method, unless the parser is configured to {@linkplain ParserSpec#collectErrors() collect
     * errors}.
     * </p>
     * 
     * @since 4.0
     ...
     * @param name used to search the matched options. May be an alias of the option name that was
     ...
     * command line.
     * 
     * @param shortName used to search the matched options. May be an alias of the option name that
    ...
    /**
     * Returns a list of matched options, in order they were matched on the command line. The
     * returned list may contain the same {@code OptionSpec} multiple times, if the option was
     * matched multiple times on the command line.
     */
    ...
    /**
     * Returns a list of matched positional parameters, in order they were matched on the command
     * line. The returned list may contain the same {@code PositionalParamSpec} multiple times, if
     * the parameter was matched multiple times on the command line.
     */
    ...
    /**
     * Returns a list of matched options and positional parameters, in order they were matched on
     * the command line. The returned list may contain an {@code OptionSpec} or
     * {@code PositionalParamSpec} multiple times, if the option or parameter was matched multiple
    ...
    public static class Builder {
      ...
      private final List<PositionalParamSpec> matchedPositionalsList =
          new ArrayList<PositionalParamSpec>();
      ...
      private final List<List<PositionalParamSpec>> positionalParams =
          new ArrayList<List<PositionalParamSpec>>();
      ...
      /**
       * Adds the specified {@code OptionSpec} or {@code PositionalParamSpec} to the list of options
       * and parameters that were matched on the command line.
       * 
       * @param arg the matched {@code OptionSpec} or {@code PositionalParamSpec}
       * @param position the command line position at which the {@code PositionalParamSpec} was
      ...
      /**
       * Adds the specified {@code PositionalParamSpec} to the list of parameters that were matched
       * on the command line.
       * 
        ...
        if (!isInitializingDefaultValues) {
          ...
          if (argSpec.group() != null) {
            GroupMatchContainer groupMatchContainer =
                this.groupMatchContainer.findLastMatchContainer(argSpec.group());
      ...
      void beforeMatchingGroupElement(ArgSpec argSpec) throws Exception {
        ...
        GroupMatchContainer foundGroupMatchContainer =
        ...
        if (foundGroupMatchContainer.lastMatch().matchedMinElements() && (argSpec.required()
            || foundGroupMatchContainer.lastMatch().matchCount(argSpec) > 0)) {
          // we need to create a new match; if maxMultiplicity has been reached, we need to add a
          // new
          // GroupMatchContainer.
    ...
    static class GroupValidationResult {
      static final GroupValidationResult SUCCESS_PRESENT =
          new GroupValidationResult(Type.SUCCESS_PRESENT);
      static final GroupValidationResult SUCCESS_ABSENT =
          new GroupValidationResult(Type.SUCCESS_ABSENT);
     ...
     * <p>
     * The {@code ParseResult} may have more than one {@code GroupMatchContainer} for an
     * {@code ArgGroupSpec}, when the group was matched more often than its maximum
     * {@linkplain ArgGroup#multiplicity() multiplicity}. This is not necessarily a problem: the
     * parser will add a match to the parent matched group until the maximum multiplicity of the
     * parent group is exceeded, in which case parser will add a match to the parent's parent group,
     * etc.
     * </p>
     * <p>
     * Ultimately, as long as the {@link ParseResult#getGroupMatches()} method does not return more
     * than one match, the maximum number of elements is not exceeded.
     * </p>
     * 
     * @since 4.0
     */
    public static class GroupMatchContainer {
      ...
      // /** Returns the {@code GroupMatchContainer} of the parent {@code ArgGroupSpec}, or {@code
      // null} if this
      // group has no parent. */
      // public GroupMatchContainer parentContainer() { return parentContainer; }
      /**
       * Returns the list of {@code GroupMatch} instances: {@code ArgGroupSpec}s with a multiplicity
       * greater than one may be matched multiple times.
       */
      ...
      void complete(CommandLine commandLine) {
        if (parentContainer == null) {
          addMatch(commandLine); // we have no choice but to potentially exceed the max multiplicity
                                 // of this
                                 // group...
        } else {
      ...
      /**
       * Returns {@code true} if the minimum number of multiples has been matched for the
       * multiplicity of this group, and each multiple has matched at least the
      ...
      /**
       * Returns {@code true} if the maximum number of multiples has been matched for the
       * multiplicity of this group, and the last multiple has
       * {@linkplain GroupMatch#matchedMaxElements() matched the maximum number of elements}, while
       * all other multiples have matched at least the {@linkplain GroupMatch#matchedMinElements()
      ...
      private GroupMatchContainer findOrCreateMatchingGroup(ArgSpec argSpec,
          CommandLine commandLine) {
      ...
      private GroupMatchContainer createGroupMatchContainer(ArgGroupSpec group,
          GroupMatchContainer parent, CommandLine commandLine) {
      ...
      List<GroupMatchContainer> findMatchContainers(ArgGroupSpec group,
      ...
      GroupMatchContainer findLastMatchContainer(ArgGroupSpec group) {
        List<GroupMatchContainer> all =
            findMatchContainers(group, new ArrayList<GroupMatchContainer>());
      ...
      void validate(CommandLine commandLine) {
        ...
        // was forced to "spill over" matches into additional GroupMatches because max multiplicity
        // was
        // exceeded.
        ...
        if (validationResult.blockingFailure()) {
          commandLine.interpreter.maybeThrow(validationResult.exception); // composite parent
                                                                          // validations
        ...
        for (GroupMatch match : matches()) {
          ...
          if (match.validationResult.blockingFailure()) {
            validationResult = match.validationResult; // potentially overwrites existing blocking
                                                       // failure
                                                       // with subgroup's!
            break;
          }
      ...
      private void failGroupMultiplicityExceeded(List<ParseResult.GroupMatch> groupMatches,
          CommandLine commandLine) {
        Map<ArgGroupSpec, List<List<ParseResult.GroupMatch>>> matchesPerGroup =
            new LinkedHashMap<ArgGroupSpec, List<List<GroupMatch>>>();
        String msg = "";
      ...
      private void validateGroupMultiplicity(CommandLine commandLine) {
        ...
        // note: matchCount == 0 if only subgroup(s) are matched for a group without args
        // (subgroups-only) //
        // TODO really?
    ...
    /**
     * A group's {@linkplain ArgGroup#multiplicity() multiplicity} specifies how many matches of a
     * group may appear on the command line. This class models a single "match". For example, this
     * group: {@code (-a -b) (-a -b)} requires two matches of its arguments to fully match.
     * 
     * @since 4.0
     */
    public static class GroupMatch {
      ...
      Map<ArgGroupSpec, GroupMatchContainer> matchedSubgroups =
          new LinkedHashMap<ArgGroupSpec, GroupMatchContainer>(2); // preserve order: used in
                                                                   // toString()
      Map<ArgSpec, List<Object>> matchedValues = new IdentityHashMap<ArgSpec, List<Object>>(); // identity
                                                                                               // map
                                                                                               // for
                                                                                               // performance
      Map<ArgSpec, List<String>> originalStringValues = new LinkedHashMap<ArgSpec, List<String>>(); // preserve
                                                                                                    ...
                                                                                                    // in
                                                                                                    // toString()
      Map<ArgSpec, Map<Integer, List<Object>>> matchedValuesAtPosition =
          new IdentityHashMap<ArgSpec, Map<Integer, List<Object>>>();
      private GroupValidationResult validationResult;
      ...
      /**
       * Returns the {@code ArgGroupSpec} of the container {@code GroupMatchContainer} of this
       * match.
       */
      public ArgGroupSpec group() {
      ...
      /**
       * Returns the values matched for the specified argument, converted to the type of the
       * argument.
       */
      ...
      void addMatchedValue(ArgSpec argSpec, int matchPosition, Object stronglyTypedValue,
          Tracer tracer) {
       ...
       * all required arguments have been matched, and for each subgroup, the
       * {@linkplain GroupMatchContainer#matchedMinElements() minimum number of elements have been
       * matched}.
       */
      boolean matchedMinElements() {
        return matchedFully(false);
      ...
      /**
       * Returns {@code true} if the maximum number of matches has been reached for this match: all
       * arguments (required or not) have been matched, and for each subgroup, the
       * {@linkplain GroupMatchContainer#matchedMaxElements() maximum number of elements have been
       * matched}.
       */
      boolean matchedMaxElements() {
        return matchedFully(true);
      ...
      void validate(CommandLine commandLine) {
        validationResult = GroupValidationResult.SUCCESS_PRESENT; // we matched _something_ or this
                                                                  // object would
                                                                  // not exist...
        if (group() != null && !group().validate()) {
          return;
        ...
        if (group() != null) {
          ...
          validationResult = group().validate(commandLine, presentCount, haveMissing,
              presentCount > 0 && haveMissing, exclusiveElements, requiredElements,
              missingElements);
        }
      }
    }
  ...
  private class Interpreter {
    ...
    private void registerBuiltInConverters() {
      ...
      // #698 use direct calls to Class.forName() and Class.getDeclaredMethod() with constant
      // Strings
      ...
      if (!excl("java.sql.Connection")) {
        try {
          reg(Class.forName("java.sql.Connection"), Class.forName("java.sql.DriverManager")
      ...
      if (!excl("java.time.LocalDateTime")) {
        try {
          reg(Class.forName("java.time.LocalDateTime"), Class.forName("java.time.LocalDateTime")
              .getDeclaredMethod("parse", CharSequence.class), CharSequence.class);
        } catch (Exception e) {
      ...
      if (!excl("java.time.OffsetDateTime")) {
        try {
          reg(Class.forName("java.time.OffsetDateTime"), Class.forName("java.time.OffsetDateTime")
              .getDeclaredMethod("parse", CharSequence.class), CharSequence.class);
        } catch (Exception e) {
      ...
      if (!excl("java.time.ZonedDateTime")) {
        try {
          reg(Class.forName("java.time.ZonedDateTime"), Class.forName("java.time.ZonedDateTime")
              .getDeclaredMethod("parse", CharSequence.class), CharSequence.class);
        } catch (Exception e) {
      ...
      if (!excl("java.time.ZoneId")) {
        try {
          reg(Class.forName("java.time.ZoneId"),
              Class.forName("java.time.ZoneId").getDeclaredMethod("of", String.class),
              String.class);
        } catch (Exception e) {
      ...
      if (!excl("java.time.ZoneOffset")) {
        try {
          reg(Class.forName("java.time.ZoneOffset"),
              Class.forName("java.time.ZoneOffset").getDeclaredMethod("of", String.class),
              String.class);
        } catch (Exception e) {
      ...
      if (!excl("java.nio.file.Path")) {
        try {
          reg(Class.forName("java.nio.file.Path"), Class.forName("java.nio.file.Paths")
              .getDeclaredMethod("get", String.class, String[].class), String.class,
              String[].class);
        } catch (Exception e) {
    ...
    List<CommandLine> parse(String... args) {
      ...
      if (tracer.isDebug()) {
        tracer.debug(
            ...
            Help.Ansi.isTTY(), System.getenv("TERM"), System.getenv("OSTYPE"),
            Help.Ansi.isWindows(), Help.Ansi.isJansiConsoleInstalled(), System.getenv("ANSICON"),
            System.getenv("ConEmuANSI"), System.getenv("NO_COLOR"), System.getenv("CLICOLOR"),
            System.getenv("CLICOLOR_FORCE"));
      }
    ...
    private void expandArgumentFile(String fileName, List<String> arguments, Set<String> visited) {
      ...
      if (!file.canRead()) {
        if (tracer.isInfo()) {
          tracer.info("File %s does not exist or cannot be read; treating argument literally%n",
              fileName);
        }
        ...
        if (commandSpec.parser().useSimplifiedAtFiles()) {
          ...
          while ((token = reader.readLine()) != null) {
            if (token.length() > 0 && !token.trim()
                .startsWith(String.valueOf(commandSpec.parser().atFileCommentChar()))) {
      ...
      do {
        ...
        try {
          ...
          String arg = offendingArgIndex >= 0 && offendingArgIndex < originalArgs.length
              ...
              : "?";
          maybeThrow(ParameterException.create(CommandLine.this, ex, arg, offendingArgIndex,
              originalArgs));
        }
    ...
    private void validateConstraints(Stack<String> argumentStack, List<ArgSpec> required,
        Set<ArgSpec> matched) {
      if (!required.isEmpty()) {
        for (ArgSpec missing : required) {
          ...
          if (missing.isOption()) {
            maybeThrow(
                MissingParameterException.create(CommandLine.this, required, config().separator()));
          } else {
    ...
    private boolean applyDefault(IDefaultValueProvider defaultValueProvider, ArgSpec arg)
        throws Exception {
      ...
      String fromProvider =
          defaultValueProvider == null ? null : defaultValueProvider.defaultValue(arg);
      ...
      if (defaultValue != null) {
        ...
        applyOption(arg, false, LookBehind.SEPARATE, false, arity, stack(defaultValue),
    ...
    private void processArguments(List<CommandLine> parsedCommands, Stack<String> args,
      ...
      while (!args.isEmpty()) {
        ...
        if (tracer.isDebug()) {
          if (actuallyUnquoted) {
            tracer.debug("Processing argument '%s' (trimmed from '%s'). Remainder=%s%n", arg,
        ...
        if (commandSpec.parser.endOfOptionsDelimiter().equals(arg)) {
          tracer.info(
              "Found end-of-options delimiter '%s'. Treating remainder as positional parameters.%n",
        ...
        if (commandSpec.subcommands().containsKey(arg)) {
          ...
          if (!isAnyHelpRequested() && !required.isEmpty()) { // ensure current command portion is
                                                              // valid
        ...
        if (separatorIndex > 0) {
          ...
          if (isStandaloneOption(key) && isStandaloneOption(arg)) {
            tracer.warn("Both '%s' and '%s' are valid option names in %s. Using '%s'...%n", arg,
                key, getCommandName(), arg);
          ...
          if (tracer.isDebug()) {
            tracer.debug("'%s' cannot be separated into <option>%s<option-parameter>%n", arg,
                separator);
          }
        }
    ...
    private boolean isStandaloneOption(String arg) {
      return commandSpec.optionsMap().containsKey(arg)
          || commandSpec.negatedOptionsMap().containsKey(arg);
    }
    ...
    private void processPositionalParameter(Collection<ArgSpec> required, Set<ArgSpec> initialized,
      ...
      if (tracer.isDebug()) {
        tracer.debug(
            "Processing next arg as a positional parameter. Command-local position=%d. Remainder=%s%n",
      ...
      Map<PositionalParamSpec, Integer> newPositions =
          new IdentityHashMap<PositionalParamSpec, Integer>();
      for (PositionalParamSpec positionalParam : commandSpec.positionalParameters()) {
        ...
        if (positionalParam.group() != null) { // does the positionalParam's index range contain the
                                               // current position in the currently matching group
          ...
          if (!indexRange.contains(localPosition)
              || (groupMatchContainer != null && groupMatchContainer.lastMatch()
                  .hasMatchedValueAtPosition(positionalParam, localPosition))) {
            continue;
          }
        } else {
          if (!indexRange.contains(localPosition)
        ...
        int actuallyConsumed =
            applyOption(positionalParam, false, LookBehind.SEPARATE, alreadyUnquoted, arity,
        ...
        if (positionalParam.group() == null) { // don't update the command-level position for group
                                               // args
      ...
      for (PositionalParamSpec positional : newPositions.keySet()) {
        ...
        if (inProgress != null) {
          ...
          if (tracer.isDebug()) {
            tracer.debug("Updated group position to %s for group %s.%n",
                inProgress.lastMatch().position, inProgress);
          }
        }
      }
      if (consumedByGroup == 0 && argsConsumed == 0 && interactiveConsumed == 0
          && !args.isEmpty()) {
        handleUnmatchedArgument(args);
      }
    }
    ...
    private void processStandaloneOption(Collection<ArgSpec> required, Set<ArgSpec> initialized,
        String arg, boolean alreadyUnquoted, Stack<String> args, LookBehind lookBehind)
        throws Exception {
      ...
      applyOption(argSpec, negated, lookBehind, alreadyUnquoted, arity, args, initialized,
          "option " + arg);
    }

    private void processClusteredShortOptions(Collection<ArgSpec> required,
        Set<ArgSpec> initialized, String arg, boolean alreadyUnquoted, Stack<String> args)
        throws Exception {
      ...
      do {
        if (cluster.length() > 0 && commandSpec.posixOptionsMap().containsKey(cluster.charAt(0))) {
          ...
          if (tracer.isDebug()) {
            tracer.debug("Found option '%s%s' in %s: %s, arity=%s%n", prefix, cluster.charAt(0),
                arg, argSpec, arity);
          }
          required.remove(argSpec);
          ...
          if (cluster.startsWith(config().separator())) {// attached with separator, like -f=FILE or
                                                         // -v=true
            lookBehind = LookBehind.ATTACHED_WITH_SEPARATOR;
          ...
          // cluster="TRUE"
          if (!empty(cluster)) {
            args.push(cluster); // interpret remainder as option parameter (CAUTION: may be empty
                                // string!)
          }
          if (first) {
            parseResultBuilder.nowProcessing.add(argSpec);
            ...
            parseResultBuilder.nowProcessing.set(parseResultBuilder.nowProcessing.size() - 1,
                argSpec); // replace
          }
          int argCount = args.size();
          int consumed = applyOption(argSpec, false, lookBehind, alreadyUnquoted, arity, args,
              initialized, argDescription);
          // if cluster was consumed as a parameter or if this field was the last in the cluster
          // we're done;
          ...
          if (arg.endsWith(cluster)) {
            ...
            if (args.peek().equals(arg)) { // #149 be consistent between unmatched short and long
                                           // options
              if (tracer.isDebug()) {
                tracer.debug(
    ...
    private int applyOption(ArgSpec argSpec, boolean negated, LookBehind lookBehind,
      ...
      boolean consumeOnlyOne =
          commandSpec.parser().aritySatisfiedByAttachedOptionParam() && lookBehind.isAttached();
      ...
      if (argSpec.type().isArray() && !(argSpec.interactive() && argSpec.type() == char[].class)) {
        result = applyValuesToArrayField(argSpec, negated, lookBehind, alreadyUnquoted, arity,
        ...
        result = applyValuesToMapField(argSpec, lookBehind, alreadyUnquoted, arity, workingStack,
            initialized, argDescription);
      } else {
    ...
    private int applyValueToSingleValuedField(ArgSpec argSpec, boolean negated,
        LookBehind lookBehind, boolean alreadyUnquoted, Range derivedArity, Stack<String> args,
      ...
      Class<?> cls = argSpec.auxiliaryTypes()[0]; // field may be interface/abstract type, use
                                                  // annotation to get
                                                  // concrete type
      if (arity.min <= 0) { // value may be optional
        ...
        if (cls == Boolean.class || cls == Boolean.TYPE) {
          ...
          boolean optionalWithBooleanValue =
              arity.max > 0 && ("true".equalsIgnoreCase(value) || "false".equalsIgnoreCase(value));
          if (!optionalWithBooleanValue && lookBehind != LookBehind.ATTACHED_WITH_SEPARATOR) { // if
                                                                                               // attached,
                                                                                               // try
                                                                                               // converting
                                                                                               // the
            ...
            Boolean defaultValue =
                booleanValue(argSpec, String.valueOf(argSpec.calcDefaultValue(true))); // #712
                                                                                       // flip
                                                                                       // the
                                                                                       // default
                                                                                       // value
            if (argSpec.isOption() && !empty(((OptionSpec) argSpec).fallbackValue())) {
              defaultValue = !booleanValue(argSpec, ((OptionSpec) argSpec).fallbackValue()); // #754
                                                                                             // Allow
                                                                                             // boolean
                                                                                             // options
                                                                                             // to
            ...
            Boolean oppositeValue =
                commandSpec.parser().toggleBooleanFlags() ? (Boolean) argSpec.getValue() // #147
                                                                                         // toggle
                                                                                         // existing
                                                                                         // boolean
                                                                                         // value
      ...
      String overwriteValueMessage =
          "Overwriting %s value with *** (masked interactive value) for %s%n";
      ...
      parseResultBuilder.addOriginalStringValue(argSpec, actualValue);// #279 track empty string
                                                                      // value if no
    ...
    private int applyValuesToMapField(ArgSpec argSpec, LookBehind lookBehind,
        boolean alreadyUnquoted, Range arity, Stack<String> args, Set<ArgSpec> initialized,
        String argDescription) throws Exception {
      ...
      if (map == null || (!map.isEmpty() && !initialized.contains(argSpec))) {
        tracer.debug("Initializing binding for %s with empty %s%n",
            optionDescription("", argSpec, 0), argSpec.type().getSimpleName());
    ...
    private void consumeMapArguments(ArgSpec argSpec, LookBehind lookBehind,
        boolean alreadyUnquoted, Range arity, Stack<String> args, Class<?>[] classes,
        ITypeConverter<?> keyConverter, ITypeConverter<?> valueConverter,
        Map<Object, Object> result, String argDescription) throws Exception {

      // don't modify Interpreter.position: same position may be consumed by multiple ArgSpec
      // objects
      ...
      for (int i = 0; consumed < arity.min && !args.isEmpty(); i++) {
        ...
        consumeOneMapArgument(argSpec, lookBehind, alreadyUnquoted, arity, consumed, args.pop(),
            classes, keyConverter, valueConverter, typedValuesAtPosition, i, argDescription);
      ...
      for (int i = consumed; consumed < arity.max && !args.isEmpty(); i++) {
        ...
        Map<Object, Object> typedValuesAtPosition = new LinkedHashMap<Object, Object>();
        parseResultBuilder.addTypedValues(argSpec, currentPosition++, typedValuesAtPosition);
        if (!canConsumeOneMapArgument(argSpec, lookBehind, alreadyUnquoted, arity, consumed,
            args.peek(), classes, keyConverter, valueConverter, argDescription)) {
          break; // leave empty map at argSpec.typedValueAtPosition[currentPosition] so we won't try
                 // to
    ...
    private void consumeOneMapArgument(ArgSpec argSpec, LookBehind lookBehind,
        boolean alreadyUnquoted, Range arity, int consumed, String arg, Class<?>[] classes,
        ITypeConverter<?> keyConverter, ITypeConverter<?> valueConverter,
        Map<Object, Object> result, int index, String argDescription) throws Exception {
      if (!lookBehind.isAttached()) {
    ...
    private String[] unquoteAndSplit(ArgSpec argSpec, LookBehind lookBehind,
        boolean alreadyUnquoted, Range arity, int consumed, String arg) {
      String raw = lookBehind.isAttached() && alreadyUnquoted ? arg : smartUnquoteIfEnabled(arg); // if
                                                                                                  // attached,
                                                                                                  // we
                                                                                                  // already
                                                                                                  // trimmed
    ...
    private boolean canConsumeOneMapArgument(ArgSpec argSpec, LookBehind lookBehind,
        boolean alreadyUnquoted, Range arity, int consumed, String arg, Class<?>[] classes,
        ITypeConverter<?> keyConverter, ITypeConverter<?> valueConverter, String argDescription) {
      String[] values = unquoteAndSplit(argSpec, lookBehind, alreadyUnquoted, arity, consumed, arg);
      try {
        for (String value : values) {
          String[] keyValue = splitKeyValue(argSpec, value);
    ...
    private String[] splitKeyValue(ArgSpec argSpec, String value) {
      ...
      if (keyValue.length < 2) {
        ...
        if (splitRegex.length() == 0) {
          ...
          throw new ParameterException(CommandLine.this,
              "Value for option " + optionDescription("", argSpec, 0) + " should be in KEY=VALUE["
    ...
    private void assertNoMissingMandatoryParameter(ArgSpec argSpec, Stack<String> args, int i,
      ...
      if (!varargCanConsumeNextValue(argSpec, args.peek())) {
        String desc =
            arity.min > 1 ? (i + 1) + " (of " + arity.min + " mandatory parameters) " : "";
        throw new MissingParameterException(CommandLine.this, argSpec, "Expected parameter " + desc
            + "for " + optionDescription("", argSpec, -1) + " but found '" + args.peek() + "'");
      }
    }
    ...
    private int applyValuesToArrayField(ArgSpec argSpec, boolean negated, LookBehind lookBehind,
      ...
      int pos = getPosition(argSpec);
      List<Object> converted = consumeArguments(argSpec, negated, lookBehind, alreadyUnquoted,
          alreadyUnquoted, arity, args, type, argDescription);
      List<Object> newValues = new ArrayList<Object>();
      if (initialized.contains(argSpec)) { // existing values are default values if initialized does
                                           // NOT contain argsSpec
    ...
    @SuppressWarnings("unchecked")
    private int applyValuesToCollectionField(ArgSpec argSpec, boolean negated,
        LookBehind lookBehind, boolean alreadyUnquoted, Range arity, Stack<String> args,
        Set<ArgSpec> initialized, String argDescription) throws Exception {
    ...
    private List<Object> consumeArguments(ArgSpec argSpec, boolean negated, LookBehind lookBehind,
      ...
      for (int i = consumed; consumed < arity.max && !args.isEmpty(); i++) {
        if (argSpec.interactive() && argSpec.arity().max == 1
          ...
          // if interactive and arity = 0..1, we consume from command line if possible (if next arg
          // not an
          ...
          List<Object> typedValuesAtPosition = new ArrayList<Object>();
          parseResultBuilder.addTypedValues(argSpec, currentPosition++, typedValuesAtPosition);
          if (!canConsumeOneArgument(argSpec, lookBehind, alreadyUnquoted, arity, consumed,
              args.peek(), type, argDescription)) {
    ...
    private int addPasswordToList(ArgSpec argSpec, Class<?> type, List<Object> result, int consumed,
      ...
      if (tracer.isInfo()) {
        tracer.info("Adding *** (masked interactive value) to %s for %s%n", argSpec.toString(),
            argDescription);
      }
    ...
    private int consumeOneArgument(ArgSpec argSpec, LookBehind lookBehind, boolean alreadyUnquoted,
        Range arity, int consumed, String arg, Class<?> type, List<Object> result, int index,
        String argDescription) {
      if (!lookBehind.isAttached()) {
        parseResultBuilder.nowProcessing(argSpec, arg);
      }
    ...
    private boolean canConsumeOneArgument(ArgSpec argSpec, LookBehind lookBehind,
        boolean alreadyUnquoted, Range arity, int consumed, String arg, Class<?> type,
        String argDescription) {
      ...
      try {
        String[] values =
            unquoteAndSplit(argSpec, lookBehind, alreadyUnquoted, arity, consumed, arg);
        // if (!argSpec.acceptsValues(values.length, commandSpec.parser())) {
        // tracer.debug("$s would split into %s values but %s cannot accept that many values.%n",
        // arg,
    ...
    /**
     * Returns true if the specified arg is "--", a registered option, or potentially a clustered
     * POSIX option. Called when parsing varargs parameters for a multi-value option. When an option
     * is encountered, the remainder should not be interpreted as vararg elements.
     * 
    ...
    private boolean isOption(String arg) {
      ...
      if (commandSpec.optionsMap().containsKey(arg)) { // -v or -f or --file (not attached to param
                                                       // or other option)
        return true;
      }
    ...
    private Object tryConvert(ArgSpec argSpec, int index, ITypeConverter<?> converter, String value,
    ...
    private boolean isAnyHelpRequested() {
      return isHelpRequested || parseResultBuilder.versionHelpRequested
    ...
    private boolean is(ArgSpec p, String attribute, boolean value) {
      if (value) {
        if (tracer.isInfo()) {
          tracer.info("%s has '%s' annotation: not validating required fields%n", p.toString(),
              attribute);
        }
      }
      return value;
    ...
    @SuppressWarnings("unchecked")
    private Collection<Object> createCollection(Class<?> collectionClass, Class<?> elementType)
        throws Exception {
    ...
    private ITypeConverter<?> getTypeConverter(final Class<?> type, ArgSpec argSpec, int index) {
      ...
      // consider adding ParserSpec.charArraysCanCaptureStrings() to allow non-interactive options
      // to capture
          ...
          public Object convert(String value) throws Exception {
            ...
            try {
              ...
              throw new TypeConversionException(
                  String.format("expected one of %s (%s) but was '%s'", Arrays.asList(names),
                      sensitivity, value));
            }
          }
        };
    ...
    private boolean booleanValue(ArgSpec argSpec, String value) {
      ...
      try {
        ...
        throw new TypeConversionException(
            "Could not convert '" + value + "' to a boolean: " + e.getMessage());
      }
    }
    ...
    private boolean assertNoMissingParameters(ArgSpec argSpec, Range arity, Stack<String> args) {
      ...
      if (arity.min > available) {
        if (arity.min == 1) {
          ...
          maybeThrow(new MissingParameterException(CommandLine.this, argSpec,
              optionDescription("", argSpec, 0) + " requires at least " + arity.min
                  + " values, but only " + available + " were specified: " + reverse(args)));
        }
        return false;
      }
      return true;
    ...
    char[] readPassword(ArgSpec argSpec) {
      String name =
          argSpec.isOption() ? ((OptionSpec) argSpec).longestName() : "position " + position;
      String prompt =
    ...
    int getPosition(ArgSpec arg) {
      ...
      GroupMatchContainer container =
          parseResultBuilder.groupMatchContainer.findLastMatchContainer(arg.group());
  ...
  /**
   * Return the unquoted value if the value contains no nested quotes, otherwise, return the value
   * as is.
   */
    ...
    for (int ch = 0, i = 0; i < unquoted.length(); i += Character.charCount(ch)) {
      ...
      switch (ch) {
        case '\\':
          ...
          break;
        case '\"':
          // if the unquoted value contains an unescaped quote, we should not convert escaped quotes
          // into quotes
          if (slashCount == 0) {
            return value;
          }
  ...
  private static class BuiltIn {
    ...
    static class ISO8601TimeConverter implements ITypeConverter<Object> {
      // Implementation note: use reflection so that picocli only requires the java.base module in
      // Java 9.
      ...
      public Object convert(String s) {
        try {
          ...
          throw new TypeConversionException(String
              .format("Internal error converting '%s' to %s (%s)", s, method.getReturnType(), e));
        }
      }
    }
  ...
  static class AutoHelpMixin {
    ...
    @Option(names = {"${picocli.help.name.0:--h}", "${picocli.help.name.1:---help}"},
        usageHelp = true, descriptionKey = "mixinStandardHelpOptions.help",
        description = "Show this help message and exit.")
    private boolean helpRequested;

    @Option(names = {"${picocli.version.name.0:--V}", "${picocli.version.name.1:---version}"},
        versionHelp = true, descriptionKey = "mixinStandardHelpOptions.version",
        description = "Print version information and exit.")
    private boolean versionRequested;
  }

  /**
   * Help command that can be installed as a subcommand on all application cli. When invoked with a
   * subcommand argument, it prints usage help for the specified subcommand. For example:
   * 
   * <pre>
   *
  ...
  public static final class HelpCommand
      implements IHelpCommandInitializable, IHelpCommandInitializable2, Runnable {
    ...
    /**
     * Invokes {@link #usage(PrintStream, Help.ColorScheme) usage} for the specified command, or for
     * the parent command.
     */
    public void run() {
    ...
    /** {@inheritDoc} */
    @Deprecated
    public void init(CommandLine helpCommandLine, Help.Ansi ansi, PrintStream out,
        PrintStream err) {
    ...
    /** {@inheritDoc} */
    public void init(CommandLine helpCommandLine, Help.ColorScheme colorScheme, PrintWriter out,
        PrintWriter err) {
      this.self = Assert.notNull(helpCommandLine, "helpCommandLine");
      this.colorScheme = Assert.notNull(colorScheme, "colorScheme");
  ...
  /**
   * Help cli that provide usage help for other cli can implement this interface to be initialized
   ...
   * {@link #init(CommandLine, CommandLine.Help.Ansi, PrintStream, PrintStream) init} method on cli
   * marked as {@link Command#helpCommand() helpCommand} before the help command's {@code run} or
   ...
   * </p>
   * <p>
   * If an error occurs in the {@code run} or {@code call} method while processing the help request,
   * it is recommended custom Help cli throw a {@link ParameterException ParameterException} with a
   * reference to the parent command. The {@link DefaultExceptionHandler DefaultExceptionHandler}
   * will print the error message and the usage for the parent command, and will terminate with the
   * exit code of the exception handler if one was set.
   * </p>
   * 
  ...
  public static interface IHelpCommandInitializable {
     ...
     * usage help for other cli.
     * 
     * @param helpCommandLine the {@code CommandLine} object associated with this help command.
     *        Implementors can use this to walk the command hierarchy and get access to the help
     *        command's parent and sibling cli.
     * @param ansi whether to use Ansi colors or not
     * @param out the stream to print the usage help message to
     * @param err the error stream to print any diagnostic messages to, in addition to the output
   ...
   * {@link #init(CommandLine, CommandLine.Help.ColorScheme, PrintWriter, PrintWriter) init} method
   * on cli marked as {@link Command#helpCommand() helpCommand} before the help command's
   * {@code run} or {@code call} method is called.
   * </p>
   * <p>
   * <b>Implementation note:</b>
   * </p>
   ...
   * If an error occurs in the {@code run} or {@code call} method while processing the help request,
   * it is recommended custom Help cli throw a {@link ParameterException ParameterException} with a
   * reference to the parent command. The {@link DefaultExceptionHandler default ParameterException
  ...
  public static interface IHelpCommandInitializable2 {
     ...
     *        Implementors can use this to walk the command hierarchy and get access to the help
     *        command's parent and sibling cli.
     * @param colorScheme the color scheme to use when printing help, including whether to use Ansi
     *        colors or not
     * @param outWriter the output writer to print the usage help message to
     * @param errWriter the error writer to print any diagnostic messages to, in addition to the
   ...
   * {@link #setHelpSectionKeys(List)} and {@link #setHelpSectionMap(Map)} to change the order of
   * sections, delete standard sections, add custom sections or replace the renderer of a standard
   * sections with a custom one.
   * <p>
   * This gives complete freedom on how a usage help message section is rendered, but it also means
   * that the section renderer is responsible for all aspects of rendering the section, including
   * layout and emitting ANSI escape codes. The {@link Help.TextTable} and {@link Help.Ansi.Text}
   * classes, and the {@link CommandLine.Help.Ansi#string(String)} and
  ...
  public interface IHelpSectionRenderer {
    /**
     * Renders a section of the usage help, like header heading, header, synopsis heading, synopsis,
     * description heading, description, etc.
     * 
   ...
   * <p>
   * <img src="doc-files/class-diagram-help-api.png" alt="Class Diagram of the CommandLine.Help
   * API">
   * </p>
   * <h2>Layered API</h2>
   * <p>
   ...
   * {@link CommandLine#usage(PrintStream, CommandLine.Help.ColorScheme)} method, application
   * authors may want to create a custom usage help message by reorganizing sections in a different
   * order and/or adding custom sections.
   * </p>
   * <p>
   ...
   * which values to display where in the table. By default, Layout shows one option or parameter
   * per table row.
   * </p>
   * <h3>TextTable</h3>
   * <p>
  ...
  public static class Help {
     ...
     * @deprecated use
     *             {@link CommandLine.Help#Help(CommandLine.Model.CommandSpec, CommandLine.Help.ColorScheme)}
     */
    @Deprecated
     ...
     * annotatations on the specified class and superclasses.
     * 
     * @param commandSpec the command config to create usage help for
     * @param colorScheme the color scheme to use
     */
    ...
    public Help addAllSubcommands(Map<String, CommandLine> commands) {
      if (commands != null) {
        ...
        // then loop over all names that the command was registered with and add this name to the
        // front of the
        ...
        // The aliases list for each command now has at least one entry, with the main name at the
        // front.
    ...
    Help addSubcommand(List<String> commandNames, CommandLine commandLine) {
      ...
      commands.put(all.substring(1, all.length() - 1), getHelpFactory()
          .create(commandLine.commandSpec, colorScheme).withCommandNames(commandNames));
      return this;
    }
     ...
     * @param command the {@code CommandSpec} or {@code @Command} annotated object to get more
     *        information from
     * @return this Help instance (for method chaining)
     * @deprecated
     */
    ...
    public String synopsis(int synopsisHeadingLength) {
      ...
      return commandSpec.usageMessage().abbreviateSynopsis() ? abbreviatedSynopsis()
          : detailedSynopsis(synopsisHeadingLength, createShortOptionArityAndNameComparator(),
              true);
    }
    ...
    public String abbreviatedSynopsis() {
      StringBuilder sb = new StringBuilder();
      if (!commandSpec.optionsMap().isEmpty()) { // only show if annotated object actually has
                                                 // options
        sb.append(" [OPTIONS]");
      }
      // sb.append(" [--] "); // implied
      for (PositionalParamSpec positionalParam : commandSpec.positionalParameters()) {
        if (!positionalParam.hidden()) {
          sb.append(' ').append(parameterLabelRenderer().renderParameterLabel(positionalParam,
              ansi(), colorScheme.parameterStyles));
        }
      }
     ...
     */
    @Deprecated
    public String detailedSynopsis(Comparator<OptionSpec> optionSort,
    ...
    public String detailedSynopsis(int synopsisHeadingLength, Comparator<OptionSpec> optionSort,
      ...
      Text optionText =
          createDetailedSynopsisOptionsText(argsInGroups, optionSort, clusterBooleanOptions);
    ...
    /**
     * Returns a Text object containing a partial detailed synopsis showing only the options and
     * positional parameters in the specified {@linkplain ArgGroup#validate() validating}
     * {@linkplain ArgGroup groups}, starting with a {@code " "} space.
     * 
     * @param outparam_groupArgs all options and positional parameters in the groups this method
     *        generates a synopsis for; these options and positional parameters should be excluded
     *        from appearing elsewhere in the synopsis
     * @return the formatted groups synopsis elements, starting with a {@code " "} space, or an
     *         empty Text if this command has no validating groups
     * @since 4.0
     */
    protected Text createDetailedSynopsisGroupsText(Set<ArgSpec> outparam_groupArgs) {
      ...
      for (ArgGroupSpec group : commandSpec().argGroups()) {
        if (group.validate()) { // non-validating groups are not shown in the synopsis
          groupText =
              groupText.concat(" ").concat(group.synopsisText(colorScheme(), outparam_groupArgs));
        }
      }
      return groupText;
    }
    ...
    /**
     * Returns a Text object containing a partial detailed synopsis showing only the options,
     * starting with a {@code " "} space. Follows the unix convention of showing optional options
     * and parameters in square brackets ({@code [ ]}).
     * 
     * @param done the list of options and positional parameters for which a synopsis was already
     *        generated. Options in this set should be excluded.
     * @param optionSort comparator to sort options or {@code null} if options should not be sorted
     * @param clusterBooleanOptions {@code true} if boolean short options should be clustered into a
     *        single string
     * @return the formatted options, starting with a {@code " "} space, or an empty Text if this
     *         command has no named options
     * @since 3.9
     */
    protected Text createDetailedSynopsisOptionsText(Collection<ArgSpec> done,
        Comparator<OptionSpec> optionSort, boolean clusterBooleanOptions) {
      Text optionText = ansi().new Text(0);
      List<OptionSpec> options = new ArrayList<OptionSpec>(commandSpec.options()); // iterate in
                                                                                   // declaration
                                                                                   // order
      if (optionSort != null) {
      ...
      if (clusterBooleanOptions) { // cluster all short boolean options into a single string
        ...
        for (OptionSpec option : options) {
          ...
          if (isFlagOption && option.arity().max <= 0) { // #612 consider arity: boolean options may
                                                         // require a parameter
            ...
            if (shortestName.length() == 2 && shortestName.startsWith("-")) { // POSIX short option
                                                                              ...
                                                                              // clustered options
                                                                              // in the synopsis
              if (!option.negatable() || shortestName.equals(commandSpec
                  .negatableOptionTransformer().makeSynopsis(shortestName, commandSpec))) {
        ...
        if (clusteredRequired.length() > 1) { // initial length was 1
          optionText =
              optionText.concat(" ").concat(colorScheme.optionText(clusteredRequired.toString()));
        }
        if (clusteredOptional.length() > 1) { // initial length was 1
          optionText = optionText.concat(" [")
              .concat(colorScheme.optionText(clusteredOptional.toString())).concat("]");
        }
      }
      for (OptionSpec option : options) {
        if (!option.hidden()) {
    ...
    /**
     * Returns a Text object containing a partial detailed synopsis showing only the positional
     * parameters, starting with a {@code " "} space. Follows the unix convention of showing
     * optional options and parameters in square brackets ({@code [ ]}).
     * 
     * @param done the list of options and positional parameters for which a synopsis was already
     *        generated. Positional parameters in this set should be excluded.
     * @return the formatted positional parameters, starting with a {@code " "} space, or an empty
     *         Text if this command has no positional parameters
     * @since 3.9
     */
    protected Text createDetailedSynopsisPositionalsText(Collection<ArgSpec> done) {
      ...
      List<PositionalParamSpec> positionals =
          new ArrayList<PositionalParamSpec>(commandSpec.positionalParameters()); // iterate in
                                                                                  // declaration
                                                                                  // order
      ...
      for (PositionalParamSpec positionalParam : positionals) {
        if (!positionalParam.hidden()) {
          ...
          Text label = parameterLabelRenderer().renderParameterLabel(positionalParam,
    ...
    /**
     * Returns a Text object containing a partial detailed synopsis showing only the subcommands,
     * starting with a {@code " "} space. Follows the unix convention of showing optional elements
     * in square brackets ({@code [ ]}).
     * 
     * @return this implementation returns " " + {@link UsageMessageSpec#synopsisSubcommandLabel()}
    ...
    /**
     * Returns the detailed synopsis text by inserting the command name before the specified text
     * with options and positional parameters details.
     * 
     * @param synopsisHeadingLength length of the synopsis heading string to be displayed on the
     *        same line as the first synopsis line. For example, if the synopsis heading is
     *        {@code "Usage: "}, this value is 7.
     * @param optionsAndPositionalsAndCommandsDetails formatted string with options, positional
     *        parameters and subcommands. Follows the unix convention of showing optional options
     *        and parameters in square brackets ({@code [ ]}).
    ...
    protected String insertSynopsisCommandName(int synopsisHeadingLength,
      ...
      // Fix for #739: infinite loop if firstColumnLength >= width (so 2nd column width becomes zero
      // or negative)
      int indent = synopsisHeadingLength + commandName.length() + 1; // +1 for space after command
                                                                     // name
      if (indent > commandSpec.usageMessage().synopsisAutoIndentThreshold() * width()) {
        ...
        indent =
            Math.min(indent, (int) (UsageMessageSpec.MAX_SYNOPSIS_AUTO_INDENT_THRESHOLD * width()));
      }
      ...
      return textTable.toString().substring(synopsisHeadingLength); // cut off leading synopsis
                                                                    // heading spaces
    }
    ...
    public String optionList() {
      Comparator<OptionSpec> sortOrder =
          commandSpec.usageMessage().sortOptions() ? createShortOptionNameComparator()
    ...
    private static Comparator<OptionSpec> createOrderComparatorIfNecessary(
        List<OptionSpec> options) {
      for (OptionSpec option : options) {
     ...
     * adds} all non-hidden options to the specified TextTable and returns the result of
     * TextTable.toString().
     * 
    ...
    public String optionList(Layout layout, Comparator<OptionSpec> optionSort,
      ...
      List<OptionSpec> options = new ArrayList<OptionSpec>(commandSpec.options()); // options are
                                                                                   // stored in
                                                                                   // order
                                                                                   // of declaration
      if (optionSort != null) {
    ...
    public String parameterList(Layout layout, IParamLabelRenderer paramLabelRenderer) {
      List<PositionalParamSpec> positionals =
          new ArrayList<PositionalParamSpec>(commandSpec.positionalParameters());
      List<ArgGroupSpec> groups = optionListGroups();
      for (ArgGroupSpec group : groups) {
    ...
    private static String heading(Ansi ansi, int usageWidth, boolean adjustCJK, String values,
        Object... params) {
      StringBuilder sb =
          join(ansi, usageWidth, adjustCJK, new String[] {values}, new StringBuilder(), params);
     ...
     * @param adjustCJK true if wide Chinese, Japanese and Korean characters should be counted as
     *        double the size of other characters for line-breaking purposes
     ...
     * @since 4.0
     */
    public static StringBuilder join(Ansi ansi, int usageHelpWidth, boolean adjustCJK,
    ...
    public String customSynopsis(Object... params) {
      return join(ansi(), width(), adjustCJK(), commandSpec.usageMessage().customSynopsis(),
          new StringBuilder(), params).toString();
    }
    ...
    public String description(Object... params) {
      return join(ansi(), width(), adjustCJK(), commandSpec.usageMessage().description(),
          new StringBuilder(), params).toString();
    }
    ...
    public String header(Object... params) {
      return join(ansi(), width(), adjustCJK(), commandSpec.usageMessage().header(),
          new StringBuilder(), params).toString();
    }
    ...
    public String footer(Object... params) {
      return join(ansi(), width(), adjustCJK(), commandSpec.usageMessage().footer(),
          new StringBuilder(), params).toString();
    }
    ...
    public String headerHeading(Object... params) {
      return heading(ansi(), width(), adjustCJK(), commandSpec.usageMessage().headerHeading(),
          params);
    }
    ...
    public String synopsisHeading(Object... params) {
      return heading(ansi(), width(), adjustCJK(), commandSpec.usageMessage().synopsisHeading(),
          params);
    }
    ...
    public String descriptionHeading(Object... params) {
      return empty(commandSpec.usageMessage().descriptionHeading()) ? ""
          : heading(ansi(), width(), adjustCJK(), commandSpec.usageMessage().descriptionHeading(),
              params);
    }

    /**
     * Returns the text displayed before the positional parameter list; an empty string if there are
     * no positional parameters, otherwise the result of
    ...
    public String parameterListHeading(Object... params) {
      return commandSpec.positionalParameters().isEmpty() ? ""
          : heading(ansi(), width(), adjustCJK(), commandSpec.usageMessage().parameterListHeading(),
              params);
    }
    ...
    public String optionListHeading(Object... params) {
      return commandSpec.optionsMap().isEmpty() ? ""
          : heading(ansi(), width(), adjustCJK(), commandSpec.usageMessage().optionListHeading(),
              params);
    }

    /**
     * Returns the text displayed before the command list; an empty string if there are no cli,
    ...
    public String commandListHeading(Object... params) {
      return commands.isEmpty() ? ""
          : heading(ansi(), width(), adjustCJK(), commandSpec.usageMessage().commandListHeading(),
              params);
    }
    ...
    public String footerHeading(Object... params) {
      return heading(ansi(), width(), adjustCJK(), commandSpec.usageMessage().footerHeading(),
          params);
    }
    ...
    public String exitCodeListHeading(Object... params) {
      return heading(ansi(), width(), adjustCJK(), commandSpec.usageMessage().exitCodeListHeading(),
          params);
    }

    /**
     * Returns a 2-column list with exit codes and their description. Descriptions containing
     * {@code "%n"} line separators are broken up into multiple lines.
     * 
    ...
    /**
     * Returns a {@code Text} object containing the command name and all aliases, separated with the
     * specified separator. Command names will use the {@link ColorScheme#commandText(String)
     * command style} for the color scheme of this Help.
     * 
     * @since 3.9
     */
    ...
    private Layout createLayout(int longOptionsColumnWidth) {
      TextTable tt =
          TextTable.forDefaultColumns(colorScheme.ansi(), longOptionsColumnWidth, width());
      tt.setAdjustLineBreaksForWideCJKCharacters(
          commandSpec.usageMessage().adjustLineBreaksForWideCJKCharacters());
      return new Layout(colorScheme, tt, createDefaultOptionRenderer(),
    ...
    /**
     * Sorts {@link OptionSpec options} by their option {@linkplain IOrdered#order() order}, lowest
     * first, highest last.
     * 
    ...
    public interface IOptionRenderer {
       ...
       * @since 3.0
       */
      Text[][] render(OptionSpec option, IParamLabelRenderer parameterLabelRenderer,
          ColorScheme scheme);
    }
    ...
    static class DefaultOptionRenderer implements IOptionRenderer {
      ...
      public Text[][] render(OptionSpec option, IParamLabelRenderer paramLabelRenderer,
          ColorScheme scheme) {
      ...
      private Text createLongOptionText(OptionSpec option, IParamLabelRenderer renderer,
          ColorScheme scheme, String longOption) {
        Text paramLabelText =
            renderer.renderParameterLabel(option, scheme.ansi(), scheme.optionParamStyles);
    ...
    static class MinimalOptionRenderer implements IOptionRenderer {
      public Text[][] render(OptionSpec option, IParamLabelRenderer parameterLabelRenderer,
          ColorScheme scheme) {
    ...
    public interface IParameterRenderer {
       ...
       * @since 3.0
       */
      Text[][] render(PositionalParamSpec param, IParamLabelRenderer parameterLabelRenderer,
          ColorScheme scheme);
    }
    ...
    static class DefaultParameterRenderer implements IParameterRenderer {
      ...
      public Text[][] render(PositionalParamSpec param, IParamLabelRenderer paramLabelRenderer,
          ColorScheme scheme) {
        Text label =
            paramLabelRenderer.renderParameterLabel(param, scheme.ansi(), scheme.parameterStyles);
        ...
        Text[] descriptionFirstLines =
            createDescriptionFirstLines(scheme, param, description, showDefault);
    ...
    private static Text[] createDescriptionFirstLines(ColorScheme scheme, ArgSpec arg,
      ...
      if (result.length == 0 || (result.length == 1 && result[0].plain.length() == 0)) {
        if (showDefault[0]) {
          result =
              new Text[] {scheme.ansi().new Text("  Default: " + arg.defaultValueString(true))};
     ...
     * option names} with a {@linkplain CommandLine.Model.ParserSpec#separator() separator} string,
     * and, unless {@link ArgSpec#hideParamSyntax()} is true, surrounds optional values with
     * {@code '['} and {@code ']'} characters and uses ellipses ("...") to indicate that any number
     * of values is allowed for options or parameters with variable arity.
     */
    static class DefaultParamLabelRenderer implements IParamLabelRenderer {
      ...
      public Text renderParameterLabel(ArgSpec argSpec, Ansi ansi, List<IStyle> styles) {
        Range capacity =
            argSpec.isOption() ? argSpec.arity() : ((PositionalParamSpec) argSpec).capacity();
        if (capacity.max == 0) {
        ...
        // show an extra trailing "[,PARAM]" if split and either max=* or splitting is not
        // restricted to max
        ...
        if (capacity.min == 0) { // optional
          String sep2 =
              empty(optionSeparator.trim()) ? optionSeparator + "[" : "[" + optionSeparator;
     ...
     * {@link #layout(CommandLine.Model.ArgSpec, CommandLine.Help.Ansi.Text[][])} method.
     * </p>
     * 
    ...
    public static class Layout {
       ...
       * implementation delegates to {@link TextTable#addRowValues(CommandLine.Help.Ansi.Text...)}
      ...
      /**
       * Calls
       * {@link #addOption(CommandLine.Model.OptionSpec, CommandLine.Help.IParamLabelRenderer)} for
       * all non-hidden Options in the list.
       * 
       ...
       * {@link #layout(CommandLine.Model.ArgSpec, CommandLine.Help.Ansi.Text[][])} method to write
       * these text values into the correct cells in the TextTable.
       * 
       ...
       * then calls {@link #layout(CommandLine.Model.ArgSpec, CommandLine.Help.Ansi.Text[][])} to
    ...
    public static class TextTable {
      ...
      /**
       * Delegates to {@link #addRowValues(CommandLine.Help.Ansi.Text...)}, after ensuring that
       * multi-line values are layed out in the correct row and column.
       * 
       ...
       * {@link TextTable#putValue(int, int, CommandLine.Help.Ansi.Text) putValue} for each of the
       * specified values, adding more empty rows if the return value indicates that the value
       * spanned multiple columns or was wrapped to multiple rows.
       * 
        ...
        switch (column.overflow) {
          ...
          case SPAN:
            ...
            do {
              ...
              if (value.length > 0 && col >= columns.length) { // we filled up all columns on this
                                                               // row
                addEmptyRow();
                row++;
                col = startColumn;
      ...
      private int copy(BreakIterator line, Text text, Text columnValue, int offset) {
        ...
        for (int start = line.first(), end = line.next(); end != BreakIterator.DONE; start =
            end, end = line.next()) {
    ...
    public static class ColorScheme {
      ...
      ColorScheme(ColorScheme.Builder builder) {
        ...
        commandStyles =
            Collections.unmodifiableList(new ArrayList<IStyle>(builder.commandStyles()));
        optionStyles = Collections.unmodifiableList(new ArrayList<IStyle>(builder.optionStyles()));
        parameterStyles =
            Collections.unmodifiableList(new ArrayList<IStyle>(builder.parameterStyles()));
        optionParamStyles =
            Collections.unmodifiableList(new ArrayList<IStyle>(builder.optionParamStyles()));
      }
      ...
      public static class Builder {
        ...
        /**
         * Constructs a color scheme builder with all attributes copied from the specified color
         * scheme.
         */
        ...
        /**
         * Adds the specified styles to the registered styles for cli in this color scheme builder
         * and returns this builder.
         * 
         * @param styles the styles to add to the registered styles for cli in this color scheme
         *        builder
        ...
        /**
         * Replaces colors and styles in this scheme builder with ones specified in system
         * properties, and returns this builder. Supported property names:
         * <ul>
    ...
    /**
     * Creates and returns a new {@link ColorScheme} initialized with picocli default values: cli
     * are bold, options and parameters use a yellow foreground, and option parameters use italic.
     * 
    ...
    public enum Ansi {
      ...
      static final boolean forceEnabled() {
        return System.getenv("CLICOLOR_FORCE") != null
      ...
      public enum Style implements IStyle {
        reset(0, 0), bold(1, 21), faint(2, 22), italic(3, 23), underline(4, 24), blink(5,
            25), reverse(7, 27), fg_black(30, 39), fg_red(31, 39), fg_green(32, 39), fg_yellow(33,
                39), fg_blue(34, 39), fg_magenta(35, 39), fg_cyan(36, 39), fg_white(37,
                    39), bg_black(40, 49), bg_red(41, 49), bg_green(42, 49), bg_yellow(43,
                        49), bg_blue(44,
         ...
         * palette.
         * 
         * @param str the case-insensitive style markup to convert, e.g. {@code "blue"} or
      ...
      public class Text implements Cloneable {
        ...
        /**
         * Returns a copy of this {@code Text} instance with the specified text concatenated to the
         * end. Does not modify this instance!
         * 
        ...
        public Text concat(Text other) {
          ...
          result.plain
              .append(other.plain.toString().substring(other.from, other.from + other.length));
        ...
        /**
         * Returns the number of columns this Text will occupy on the console, adjusted for wide CJK
         * characters.
         * 
         * @return the number of columns this Text will occupy on the console, adjusted for wide CJK
         *         characters
         * @since 4.0
         */
        ...
        /**
         * Returns the number of columns that the specified portion of this Text will occupy on the
         * console, adjusted for wide CJK characters.
         * 
         * @param fromPosition the position to start counting
         * @param charCount the number of characters in this Text to consider
         * @return the number of columns that the specified portion of this Text will occupy on the
         *         console, adjusted for wide CJK characters
         * @since 4.0
         */
   ...
   * {@code CommandLine} object where the cause exception occurred, so that client code can tailor
   * their handling for the specific command (print the command's usage help message, for example).
   * 
   * @since 2.0
   */
  ...
  public static class ParameterException extends PicocliException {
    ...
    private static ParameterException create(CommandLine cmd, Exception ex, String arg, int i,
        String[] args) {
  ...
  /**
   * Exception indicating that the user input included multiple arguments from a mutually exclusive
   * group.
   * 
   * @since 4.0
   */
  ...
  public static class DuplicateOptionAnnotationsException extends DuplicateNameException {
    ...
    private static DuplicateOptionAnnotationsException create(String name, ArgSpec argSpec1,
        ArgSpec argSpec2) {
  ...
  public static class UnmatchedArgumentException extends ParameterException {
    ...
    /**
     * Returns {@code true} and prints suggested solutions to the specified stream if such solutions
    ...
    /**
     * Returns {@code true} and prints suggested solutions to the specified writer if such solutions
     * exist, otherwise returns {@code false}.
     * 
     * @since 4.0
     */
    ...
    public List<String> getSuggestions() {
      ...
      if (spec.resemblesOption(arg, null)) {
        return spec
            .findOptionNamesWithPrefix(stripped.substring(0, Math.min(2, stripped.length())));
    ...
    private static String describe(List<String> unmatch, CommandLine cmd) {
      ...
      return isUnknownOption(unmatch, cmd) ? "Unknown option" + plural
          : "Unmatched argument" + plural + at + " index "
              + (cmd.interpreter.parseResultBuilder == null ? "0"
