...
/**
 * AST visitor with default methods to check equality between two ASTs (excluding comments and whitespace from
 * comparison). It is meant as a base implementation to match ASTs using a more complex logic.
 * 
 * @author Mathieu
...
public class BaseEqualityMatcher implements GenericVisitor<Boolean, Node>
{
	...
	protected final boolean nodesEquals(Optional<? extends NodeList<?>> n, Optional<? extends NodeList<?>> n2)
	{
